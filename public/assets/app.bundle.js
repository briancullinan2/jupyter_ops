...
// module
exports.push([module.i, "/**\n * Applies styles for users in high contrast mode. Note that this only applies\n * to Microsoft browsers. Chrome can be included by checking for the `html[hc]`\n * attribute, however Chrome handles high contrast differently.\n */\n/* Theme for the ripple elements.*/\n/** The mixins below are shared between md-menu and md-select */\n/**\n * This mixin adds the correct panel transform styles based\n * on the direction that the menu panel opens.\n */\n/* stylelint-disable material/no-prefixes */\n/* stylelint-enable */\n/**\n * This mixin contains shared option styles between the select and\n * autocomplete components.\n */\n/**\n * Applies styles for users in high contrast mode. Note that this only applies\n * to Microsoft browsers. Chrome can be included by checking for the `html[hc]`\n * attribute, however Chrome handles high contrast differently.\n */\n/* Theme for the ripple elements.*/\n/** The mixins below are shared between md-menu and md-select */\n/**\n * This mixin adds the correct panel transform styles based\n * on the direction that the menu panel opens.\n */\n/* stylelint-disable material/no-prefixes */\n/* stylelint-enable */\n/**\n * This mixin contains shared option styles between the select and\n * autocomplete components.\n */\n/**\n * Applies styles for users in high contrast mode. Note that this only applies\n * to Microsoft browsers. Chrome can be included by checking for the `html[hc]`\n * attribute, however Chrome handles high contrast differently.\n */\n/* Theme for the ripple elements.*/\n/** The mixins below are shared between md-menu and md-select */\n/**\n * This mixin adds the correct panel transform styles based\n * on the direction that the menu panel opens.\n */\n/* stylelint-disable material/no-prefixes */\n/* stylelint-enable */\n/**\n * This mixin contains shared option styles between the select and\n * autocomplete components.\n */\n:host .app-wrapper {\n  font-size: 18px;\n  text-rendering: geometricPrecision;\n  font-family: 'Poppins', Arial, sans-serif;\n  display: block;\n  transition: ease-in-out .15s;\n  overflow: hidden;\n  height: 100%; }\n  :host .app-wrapper a {\n    position: absolute;\n    top: 0;\n    right: 0;\n    padding: 5px;\n    font-size: 30px;\n    line-height: 30px;\n    z-index: 100; }\n  :host .app-wrapper router-outlet /deep/ ~ * {\n    position: fixed;\n    height: 100%;\n    right: 0;\n    pointer-events: none;\n    background: white;\n    box-shadow: inset 0 0 60px rgba(0, 0, 0, 0.2);\n    color: #444444; }\n\n:host.jupytangular {\n  position: fixed;\n  right: 10px;\n  top: 0;\n  left: auto;\n  bottom: auto;\n  z-index: 99999999;\n  opacity: .2;\n  transition: ease-in-out .15s;\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  max-height: 40px;\n  max-width: 40px; }\n  :host.jupytangular.expanded {\n    opacity: 0.8; }\n  :host.jupytangular router-outlet /deep/ ~ *:hover, :host.jupytangular:hover, :host.jupytangular:focus, :host.jupytangular:active {\n    opacity: 1; }\n    :host.jupytangular router-outlet /deep/ ~ *:hover router-outlet /deep/ ~ *, :host.jupytangular router-outlet /deep/ ~ *:hover, :host.jupytangular:hover router-outlet /deep/ ~ *, :host.jupytangular:hover, :host.jupytangular:focus router-outlet /deep/ ~ *, :host.jupytangular:focus, :host.jupytangular:active router-outlet /deep/ ~ *, :host.jupytangular:active {\n      pointer-events: initial; }\n", ""]);
