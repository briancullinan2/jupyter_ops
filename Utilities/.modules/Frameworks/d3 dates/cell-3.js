...
// *****************************************
    ...
    module.exports = function d3Heatmap(data) {
        ...
        function exports(nestedData) {
            ...
            var rect = year.selectAll('.day')
                .data(function (d) { 
                  return (d === moment().year()) ? d3.time.days(new Date(d, 0, 1), new Date(d , moment().month(), moment().date())) : d3.timeDays(new Date(d, 0, 1), new Date(d + 1, 0, 1)); 
                })
                .enter().append('rect')
                    .attr({
                        'fill': function (d) { 
                            console.log(colour(nestedData[d]));
        ...
        return exports.colourRangeStart('#FDBB30')
