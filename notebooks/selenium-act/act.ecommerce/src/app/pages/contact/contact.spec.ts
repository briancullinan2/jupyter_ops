...
describe('ContactComponent', function () {
    ...
    let trial: ContactComponent;
    let trialFixture: ComponentFixture<ContactComponent>;

    // mock everything the SharedModule includes because we need to override AuthService
    beforeEach(() => {
        fixture = Core.createAppWithShared([ContactModule], [
            {
                path: 'contact',
        ...
        trialFixture = TestBed.createComponent(ContactComponent);
