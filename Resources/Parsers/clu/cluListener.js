...
// This class defines a complete listener for a parse tree produced by cluParser.
export default class cluListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by cluParser#exception_.
	enterException_(ctx) {
	}

	// Exit a parse tree produced by cluParser#exception_.
	exitException_(ctx) {
	}


	// Enter a parse tree produced by cluParser#type_spec_list.
	enterType_spec_list(ctx) {
	}

	// Exit a parse tree produced by cluParser#type_spec_list.
	exitType_spec_list(ctx) {
	}


	// Enter a parse tree produced by cluParser#where_.
	enterWhere_(ctx) {
	}

	// Exit a parse tree produced by cluParser#where_.
	exitWhere_(ctx) {
	}
