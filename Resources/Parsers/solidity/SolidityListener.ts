...
import { ElementaryTypeNameExpressionContext } from "./SolidityParser";
...
export interface SolidityListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	enterElementaryTypeNameExpression?: (ctx: ElementaryTypeNameExpressionContext) => void;
	/**
	 * Exit a parse tree produced by `SolidityParser.elementaryTypeNameExpression`.
	 * @param ctx the parse tree
	 */
	exitElementaryTypeNameExpression?: (ctx: ElementaryTypeNameExpressionContext) => void;
