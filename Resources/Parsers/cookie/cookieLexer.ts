...
export class cookieLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(cookieLexer._LITERAL_NAMES, cookieLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(cookieLexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return cookieLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return cookieLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return cookieLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return cookieLexer.modeNames; }
	...
	public static get _ATN(): ATN {
		if (!cookieLexer.__ATN) {
			cookieLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(cookieLexer._serializedATN));
		}
