...
export default class SmalltalkListener extends antlr4.tree.ParseTreeListener {
	...
	enterCharConstant(ctx) {
	}

	// Exit a parse tree produced by SmalltalkParser#charConstant.
	exitCharConstant(ctx) {
	}


	// Enter a parse tree produced by SmalltalkParser#hex_.
	enterHex_(ctx) {
	}

	// Exit a parse tree produced by SmalltalkParser#hex_.
	exitHex_(ctx) {
	}
