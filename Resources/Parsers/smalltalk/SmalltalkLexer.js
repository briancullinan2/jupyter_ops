...
var SmalltalkLexer = /** @class */ (function (_super) {
    __extends(SmalltalkLexer, _super);
    // tslint:enable:no-trailing-whitespace
    function SmalltalkLexer(input) {
        var _this = _super.call(this, input) || this;
        _this._interp = new LexerATNSimulator_1.LexerATNSimulator(SmalltalkLexer._ATN, _this);
        return _this;
    }
    Object.defineProperty(SmalltalkLexer.prototype, "vocabulary", {
        // @Override
        // @NotNull
        get: function () {
    ...
    Object.defineProperty(SmalltalkLexer.prototype, "grammarFileName", {
        // @Override
        get: function () { return "Smalltalk.g4"; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(SmalltalkLexer.prototype, "ruleNames", {
        // @Override
        get: function () { return SmalltalkLexer.ruleNames; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(SmalltalkLexer.prototype, "serializedATN", {
        // @Override
        get: function () { return SmalltalkLexer._serializedATN; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(SmalltalkLexer.prototype, "channelNames", {
        // @Override
        get: function () { return SmalltalkLexer.channelNames; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(SmalltalkLexer.prototype, "modeNames", {
        // @Override
        get: function () { return SmalltalkLexer.modeNames; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(SmalltalkLexer, "_ATN", {
        get: function () {
            if (!SmalltalkLexer.__ATN) {
                SmalltalkLexer.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(SmalltalkLexer._serializedATN));
            }
    ...
    SmalltalkLexer.channelNames = [
        "DEFAULT_TOKEN_CHANNEL", "HIDDEN",
    ];
    // tslint:disable:no-trailing-whitespace
    SmalltalkLexer.modeNames = [
        "DEFAULT_MODE",
    ];
    SmalltalkLexer.ruleNames = [
    ...
    SmalltalkLexer._LITERAL_NAMES = [
        undefined, undefined, undefined, undefined, "'['", "']'", "')'", "'('",
        "'|'", "'.'", "';'", undefined, "'<'", "'>'", "'-'", undefined, undefined,
        "'^'", "':'", "':='", "'#'", "'$'", "'e'", "'16r'", "'#('", "'#{'", "'}'",
        "'{'",
    ];
    SmalltalkLexer._SYMBOLIC_NAMES = [
    ...
    SmalltalkLexer.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(SmalltalkLexer._LITERAL_NAMES, SmalltalkLexer._SYMBOLIC_NAMES, []);
    SmalltalkLexer._serializedATN = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\"\xBE\b\x01\x04" +
    ...
    return SmalltalkLexer;
}(Lexer_1.Lexer));
exports.SmalltalkLexer = SmalltalkLexer;
