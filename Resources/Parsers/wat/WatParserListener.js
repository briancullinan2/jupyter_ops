// Generated from Resources/Parsers/wat/WatParser.g4 by ANTLR 4.10.1
// jshint ignore: start
import antlr4 from 'antlr4';

// This class defines a complete listener for a parse tree produced by WatParser.
export default class WatParserListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by WatParser#var_.
	enterVar_(ctx) {
	}

	// Exit a parse tree produced by WatParser#var_.
	exitVar_(ctx) {
	}
	...
	// Enter a parse tree produced by WatParser#func_.
	enterFunc_(ctx) {
	}

	// Exit a parse tree produced by WatParser#func_.
	exitFunc_(ctx) {
	}
	...
	// Enter a parse tree produced by WatParser#export_.
	enterExport_(ctx) {
	}

	// Exit a parse tree produced by WatParser#export_.
	exitExport_(ctx) {
	}


	// Enter a parse tree produced by WatParser#inline_export.
	enterInline_export(ctx) {
	}

	// Exit a parse tree produced by WatParser#inline_export.
	exitInline_export(ctx) {
	}
	...
	// Enter a parse tree produced by WatParser#start_.
	enterStart_(ctx) {
	}

	// Exit a parse tree produced by WatParser#start_.
	exitStart_(ctx) {
	}


	// Enter a parse tree produced by WatParser#module_field.
	enterModule_field(ctx) {
	}

	// Exit a parse tree produced by WatParser#module_field.
	exitModule_field(ctx) {
	}
	...
	enterScript_module(ctx) {
	}

	// Exit a parse tree produced by WatParser#script_module.
	exitScript_module(ctx) {
	}


	// Enter a parse tree produced by WatParser#action_.
	enterAction_(ctx) {
	}

	// Exit a parse tree produced by WatParser#action_.
	exitAction_(ctx) {
	}
