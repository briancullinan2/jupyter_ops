 ...
 * `COOLParser`.
 */
export interface COOLListener extends ParseTreeListener {
	/**
	...
	/**
	 * Enter a parse tree produced by `COOLParser.programBlocks`.
	 * @param ctx the parse tree
	 */
	enterProgramBlocks?: (ctx: ProgramBlocksContext) => void;
	/**
	 * Exit a parse tree produced by `COOLParser.programBlocks`.
	 * @param ctx the parse tree
	 */
