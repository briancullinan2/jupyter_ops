...
export default class httpListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by httpParser#http_message.
	enterHttp_message(ctx) {
	}

	// Exit a parse tree produced by httpParser#http_message.
	exitHttp_message(ctx) {
	}
