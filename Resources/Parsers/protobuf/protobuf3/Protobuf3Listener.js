...
export default class Protobuf3Listener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by Protobuf3Parser#twoPassParse.
	enterTwoPassParse(ctx) {
	}

	// Exit a parse tree produced by Protobuf3Parser#twoPassParse.
	exitTwoPassParse(ctx) {
	}
	...
	// Enter a parse tree produced by Protobuf3Parser#doEnterBlock.
	enterDoEnterBlock(ctx) {
	}

	// Exit a parse tree produced by Protobuf3Parser#doEnterBlock.
	exitDoEnterBlock(ctx) {
	}


	// Enter a parse tree produced by Protobuf3Parser#doEnumNameDef.
	enterDoEnumNameDef(ctx) {
	}

	// Exit a parse tree produced by Protobuf3Parser#doEnumNameDef.
	exitDoEnumNameDef(ctx) {
	}


	// Enter a parse tree produced by Protobuf3Parser#doExitBlock.
	enterDoExitBlock(ctx) {
	}

	// Exit a parse tree produced by Protobuf3Parser#doExitBlock.
	exitDoExitBlock(ctx) {
	}


	// Enter a parse tree produced by Protobuf3Parser#doMessageNameDef.
	enterDoMessageNameDef(ctx) {
	}

	// Exit a parse tree produced by Protobuf3Parser#doMessageNameDef.
	exitDoMessageNameDef(ctx) {
	}


	// Enter a parse tree produced by Protobuf3Parser#doServiceNameDef.
	enterDoServiceNameDef(ctx) {
	}

	// Exit a parse tree produced by Protobuf3Parser#doServiceNameDef.
	exitDoServiceNameDef(ctx) {
	}
