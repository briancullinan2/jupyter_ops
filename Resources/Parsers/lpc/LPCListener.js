...
export default class LPCListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by LPCParser#lpc_program.
	enterLpc_program(ctx) {
	}
