...
export class LexUnicode extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(LexUnicode._LITERAL_NAMES, LexUnicode._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(LexUnicode._ATN, this);
	}

	// @Override
	public get grammarFileName(): string { return "LexUnicode.g4"; }

	// @Override
	public get ruleNames(): string[] { return LexUnicode.ruleNames; }

	// @Override
	public get serializedATN(): string { return LexUnicode._serializedATN; }

	// @Override
	public get channelNames(): string[] { return LexUnicode.channelNames; }

	// @Override
	public get modeNames(): string[] { return LexUnicode.modeNames; }

	public static readonly _serializedATN: string =
		"\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\x02$\b\x01\x04" +
	...
	public static get _ATN(): ATN {
		if (!LexUnicode.__ATN) {
			LexUnicode.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(LexUnicode._serializedATN));
		}
