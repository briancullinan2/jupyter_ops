// Generated from Resources/Parsers/stringtemplate/STParser.g4 by ANTLR 4.10.1
// jshint ignore: start
import antlr4 from 'antlr4';

// This class defines a complete listener for a parse tree produced by STParser.
export default class STParserListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by STParser#template_.
	enterTemplate_(ctx) {
	}

	// Exit a parse tree produced by STParser#template_.
	exitTemplate_(ctx) {
	}
	...
	// Enter a parse tree produced by STParser#list_.
	enterList_(ctx) {
	}

	// Exit a parse tree produced by STParser#list_.
	exitList_(ctx) {
	}
