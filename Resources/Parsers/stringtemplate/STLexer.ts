...
export class STLexer extends LexerAdaptor {
	...
	public static readonly SubTemplate = 2;
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(STLexer._LITERAL_NAMES, STLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(STLexer._ATN, this);
	}

	// @Override
	public get grammarFileName(): string { return "STLexer.g4"; }

	// @Override
	public get ruleNames(): string[] { return STLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return STLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return STLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return STLexer.modeNames; }
	...
	private LDELIM_sempred(_localctx: RuleContext, predIndex: number): boolean {
		switch (predIndex) {
		case 2:
			return  isLDelim() ;
		}
	...
	private RDELIM_sempred(_localctx: RuleContext, predIndex: number): boolean {
		switch (predIndex) {
		case 6:
			return  isRDelim() ;
		}
	...
	private LTmplMark_sempred(_localctx: RuleContext, predIndex: number): boolean {
		switch (predIndex) {
		case 7:
	...
	private RTmplMark_sempred(_localctx: RuleContext, predIndex: number): boolean {
		switch (predIndex) {
		case 8:
	...
	private static readonly _serializedATNSegment1: string =
		"\x02\x02\u0148\b\x03\x02\x02\x02\u0149\u014A\x05#\x11\x02\u014A\u014B" +
	...
	public static get _ATN(): ATN {
		if (!STLexer.__ATN) {
			STLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(STLexer._serializedATN));
		}
