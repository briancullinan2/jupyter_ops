...
// This class defines a complete listener for a parse tree produced by STGParser.
export default class STGParserListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by STGParser#template_.
	enterTemplate_(ctx) {
	}

	// Exit a parse tree produced by STGParser#template_.
	exitTemplate_(ctx) {
	}
	...
	// Enter a parse tree produced by STGParser#dict_.
	enterDict_(ctx) {
	}

	// Exit a parse tree produced by STGParser#dict_.
	exitDict_(ctx) {
	}
