...
import { AnoymousFunctionDeclContext } from "./JavaScriptParser";
...
import { AnoymousFunctionContext } from "./JavaScriptParser";
...
export interface JavaScriptParserListener extends ParseTreeListener {
	 ...
	 * labeled alternative in `JavaScriptParser.anoymousFunction`.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by the `AnoymousFunctionDecl`
	 * labeled alternative in `JavaScriptParser.anoymousFunction`.
	 * @param ctx the parse tree
	 */
	enterAnoymousFunctionDecl?: (ctx: AnoymousFunctionDeclContext) => void;
	/**
	 * Exit a parse tree produced by the `AnoymousFunctionDecl`
	 * labeled alternative in `JavaScriptParser.anoymousFunction`.
	 * @param ctx the parse tree
	 */
	exitAnoymousFunctionDecl?: (ctx: AnoymousFunctionDeclContext) => void;
	...
	/**
	 * Enter a parse tree produced by `JavaScriptParser.anoymousFunction`.
	 * @param ctx the parse tree
	 */
	enterAnoymousFunction?: (ctx: AnoymousFunctionContext) => void;
	/**
	 * Exit a parse tree produced by `JavaScriptParser.anoymousFunction`.
	 * @param ctx the parse tree
	 */
	exitAnoymousFunction?: (ctx: AnoymousFunctionContext) => void;
