...
export default class JavaScriptParserListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by JavaScriptParser#singleVariableDeclaration.
	enterSingleVariableDeclaration(ctx) {
	}

	// Exit a parse tree produced by JavaScriptParser#singleVariableDeclaration.
	exitSingleVariableDeclaration(ctx) {
	}
