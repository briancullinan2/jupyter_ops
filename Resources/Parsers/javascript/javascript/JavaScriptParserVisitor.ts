...
export interface JavaScriptParserVisitor<Result> extends ParseTreeVisitor<Result> {
	...
	/**
	 * Visit a parse tree produced by the `AnoymousFunctionDecl`
	 * labeled alternative in `JavaScriptParser.anoymousFunction`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitAnoymousFunctionDecl?: (ctx: AnoymousFunctionDeclContext) => Result;
	...
	/**
	 * Visit a parse tree produced by `JavaScriptParser.anoymousFunction`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitAnoymousFunction?: (ctx: AnoymousFunctionContext) => Result;
