...
export class ECMAScriptParser extends Parser {
	...
	public static readonly Equals_ = 31;
	...
	public static readonly HtmlComment = 103;
	public static readonly UnexpectedCharacter = 104;
	...
	public getter(): GetterContext {
		...
		try {
			...
			if (!(_input.LT(1).Text.Equals("get"))) {
				throw new FailedPredicateException(this, "_input.LT(1).Text.Equals(\"get\")");
			}
			this.state = 607;
			this.match(ECMAScriptParser.Identifier);
			this.state = 608;
	...
	public setter(): SetterContext {
		...
		try {
			...
			if (!(_input.LT(1).Text.Equals("set"))) {
				throw new FailedPredicateException(this, "_input.LT(1).Text.Equals(\"set\")");
			}
			this.state = 611;
			this.match(ECMAScriptParser.Identifier);
			this.state = 612;
		...
		try {
			...
			case 4:
				...
				if (!(_input.LT(1).Type == CloseBrace)) {
					throw new FailedPredicateException(this, "_input.LT(1).Type == CloseBrace");
				}
				}
				break;
			}
...
export class EqualityExpressionContext extends SingleExpressionContext {
	...
	public Equals_(): TerminalNode | undefined { return this.tryGetToken(ECMAScriptParser.Equals_, 0); }
