// Generated from C:/Users/megam/jupyter_ops/Resources/Parsers/javascript/ecmascript/TypeScript/ECMAScript.g4 by ANTLR 4.13.2
// jshint ignore: start
...
export default class ECMAScriptParser extends antlr4.Parser {
    ...
    constructor(input) {
         ...
         */
        	lineTerminatorAhead(): boolean {
        		const ahead = this._input.get(this.currentToken.tokenIndex)
    ...
    getter_sempred(localctx, predIndex) {
    	switch(predIndex) {
    		case 28:
    			return this._input.LT(1).text?.startsWith("get") ?? false;
    		default:
    			throw "No predicate with index:" + predIndex;
    	}
    };
    ...
    setter_sempred(localctx, predIndex) {
    	switch(predIndex) {
    		case 29:
    			return this._input.LT(1).text?.startsWith("set") ?? false;
    		default:
    			throw "No predicate with index:" + predIndex;
    	}
    };
	    ...
	    try {
	        ...
	        case 1:
	            ...
	            if (!( this._input.LT(1).type != ECMAScriptParser.Function)) {
	                throw new antlr4.error.FailedPredicateException(this, "this._input.LT(1).type != ECMAScriptParser.Function");
	            }
	            this.state = 121;
	            this.statement();
	            break;
	    ...
	    try {
	        ...
	        case 4:
	            ...
	            if (!( this._input.LT(1).type != ECMAScriptParser.OpenBrace)) {
	                throw new antlr4.error.FailedPredicateException(this, "this._input.LT(1).type != ECMAScriptParser.OpenBrace");
	            }
	            this.state = 129;
	...
	getter() {
	    ...
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 607;
	        if (!( this._input.LT(1).text?.startsWith("get") ?? false)) {
	            throw new antlr4.error.FailedPredicateException(this, "this._input.LT(1).text?.startsWith(\"get\") ?? false");
	        }
	        this.state = 608;
	        this.match(ECMAScriptParser.Identifier);
	        this.state = 609;
	...
	setter() {
	    ...
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 611;
	        if (!( this._input.LT(1).text?.startsWith("set") ?? false)) {
	            throw new antlr4.error.FailedPredicateException(this, "this._input.LT(1).text?.startsWith(\"set\") ?? false");
	        }
	        this.state = 612;
	        this.match(ECMAScriptParser.Identifier);
	        this.state = 613;
