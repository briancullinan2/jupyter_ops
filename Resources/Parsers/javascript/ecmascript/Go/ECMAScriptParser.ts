...
export class ECMAScriptParser extends Parser {
	...
	public static readonly RULE_voidStatement = 10;
		...
		try {
			...
			case 1:
				...
				if (!(p.GetInputStream().LA(1) != ECMAScriptParserFunction)) {
					throw new FailedPredicateException(this, "p.GetInputStream().LA(1) != ECMAScriptParserFunction");
				}
				this.state = 121;
				this.statement();
				}
		...
		try {
			...
			case 4:
				...
				if (!(p.GetInputStream().LA(1) != ECMAScriptParserOpenBrace)) {
					throw new FailedPredicateException(this, "p.GetInputStream().LA(1) != ECMAScriptParserOpenBrace");
				}
				this.state = 129;
	...
	// @RuleVersion(0)
	public voidStatement(): VoidStatementContext {
		let _localctx: VoidStatementContext = new VoidStatementContext(this._ctx, this.state);
				...
				if (_alt === 1) {
					...
					case 19:
						...
						if (!(!p.here(ECMAScriptParserLineTerminator))) {
							throw new FailedPredicateException(this, "!p.here(ECMAScriptParserLineTerminator)");
						}
						this.state = 574;
						this.match(ECMAScriptParser.PlusPlus);
						}
	...
	public getter(): GetterContext {
		...
		try {
			...
			if (!(p.GetTokenStream().LT(1).GetText() == "get")) {
				throw new FailedPredicateException(this, "p.GetTokenStream().LT(1).GetText() == \"get\"");
			}
			this.state = 605;
			this.match(ECMAScriptParser.Identifier);
			this.state = 606;
	...
	public setter(): SetterContext {
		...
		try {
			...
			if (!(p.GetTokenStream().LT(1).GetText() == "set")) {
				throw new FailedPredicateException(this, "p.GetTokenStream().LT(1).GetText() == \"set\"");
			}
			this.state = 609;
			this.match(ECMAScriptParser.Identifier);
			this.state = 610;
		...
		try {
			...
			case 3:
				...
				if (!(p.lineTerminatorAhead())) {
					throw new FailedPredicateException(this, "p.lineTerminatorAhead()");
				}
				}
				break;
			...
			case 4:
				...
				if (!(p.GetTokenStream().LT(1).GetTokenType() == ECMAScriptParserCloseBrace)) {
					throw new FailedPredicateException(this, "p.GetTokenStream().LT(1).GetTokenType() == ECMAScriptParserCloseBrace");
				}
				}
				break;
			}
...
export class StatementContext extends ParserRuleContext {
	...
	public voidStatement(): VoidStatementContext | undefined {
...
export class VoidStatementContext extends ParserRuleContext {
	public SemiColon(): TerminalNode { return this.getToken(ECMAScriptParser.SemiColon, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return ECMAScriptParser.RULE_voidStatement; }
	// @Override
	public enterRule(listener: ECMAScriptListener): void {
