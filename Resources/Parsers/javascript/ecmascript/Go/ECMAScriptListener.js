...
export default class ECMAScriptListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by ECMAScriptParser#voidStatement.
	enterVoidStatement(ctx) {
	}

	// Exit a parse tree produced by ECMAScriptParser#voidStatement.
	exitVoidStatement(ctx) {
	}
