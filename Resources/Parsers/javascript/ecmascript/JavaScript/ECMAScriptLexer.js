...
var ECMAScriptLexer = /** @class */ (function (_super) {
    ...
    function ECMAScriptLexer(input) {
        ...
        _this.getStrictMode = function () {
            return this.strictMode;
        };
        _this.setStrictMode = function (strictMode) {
            this.strictMode = strictMode;
        };
        _this.nextToken = function () {
            var next = antlr4.Lexer.prototype.nextToken.call(this);
            if (next.channel == antlr4.Token.DEFAULT_CHANNEL)
                this.lastToken = next;
            return next;
        };
        _this.isRegexPossible = function () {
    ...
    ECMAScriptLexer._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02i\u03B7\b\x01" +
    ...
    ECMAScriptLexer._serializedATNSegment1 = "\u013B\u013C\x07/\x02\x02\u013C&\x03\x02\x02\x02\u013D\u013E\x07\x80\x02" +
