"use strict";
// Generated from /Users/briancullinan/jupyter_ops/Resources/Parsers/javascript/ecmascript/JavaScript/ECMAScript.g4 by ANTLR 4.7.3-SNAPSHOT
...
var ECMAScriptParser = /** @class */ (function (_super) {
    ...
    function ECMAScriptParser(input) {
        ...
        _this.lineTerminatorAhead = function () {
            var possibleIndexEosToken = antlr4.Parser.prototype.getCurrentToken.call(this).tokenIndex - 1;
            var ahead = this._input.get(possibleIndexEosToken);
        ...
        _this._interp = new ParserATNSimulator_1.ParserATNSimulator(ECMAScriptParser._ATN, _this);
        return _this;
    }
                ...
                case 1:
                    this.enterOuterAlt(_localctx, 1);
                    {
                        ...
                        if (!(this._input.LA(1).type != ECMAScriptParser.Function)) {
                            throw new FailedPredicateException_1.FailedPredicateException(this, "this._input.LA(1).type != ECMAScriptParser.Function");
                        }
                        this.state = 121;
                        this.statement();
                    }
                ...
                case 4:
                    this.enterOuterAlt(_localctx, 4);
                    {
                        ...
                        if (!(this._input.LA(1).type != ECMAScriptParser.OpenBrace)) {
                            throw new FailedPredicateException_1.FailedPredicateException(this, "this._input.LA(1).type != ECMAScriptParser.OpenBrace");
                        }
                        this.state = 129;
                    ...
                    case 1:
                        {
                            ...
                            if (!(!this.here(ECMAScriptParser.LineTerminator))) {
                                throw new FailedPredicateException_1.FailedPredicateException(this, "!this.here(ECMAScriptParser.LineTerminator)");
                            }
                            this.state = 251;
                            this.match(ECMAScriptParser.Identifier);
                        }
        ...
        try {
            this.enterOuterAlt(_localctx, 1);
            {
                ...
                if (!(this._input.LT(1).text.startsWith("get"))) {
                    throw new FailedPredicateException_1.FailedPredicateException(this, "this._input.LT(1).text.startsWith(\"get\")");
                }
                this.state = 608;
                this.match(ECMAScriptParser.Identifier);
                this.state = 609;
        ...
        try {
            this.enterOuterAlt(_localctx, 1);
            {
                ...
                if (!(this._input.LT(1).text.startsWith("set"))) {
                    throw new FailedPredicateException_1.FailedPredicateException(this, "this._input.LT(1).text.startsWith(\"set\")");
                }
                this.state = 612;
                this.match(ECMAScriptParser.Identifier);
                this.state = 613;
                ...
                case 4:
                    this.enterOuterAlt(_localctx, 4);
                    {
                        ...
                        if (!(this._input.LT(1).type == ECMAScriptParser.CloseBrace)) {
                            throw new FailedPredicateException_1.FailedPredicateException(this, "this._input.LT(1).type == ECMAScriptParser.CloseBrace");
                        }
                    }
                    break;
            }
    ...
    ECMAScriptParser.prototype.sempred = function (_localctx, ruleIndex, predIndex) {
        switch (ruleIndex) {
            case 2:
    ...
    ECMAScriptParser.prototype.sourceElement_sempred = function (_localctx, predIndex) {
        switch (predIndex) {
            case 0:
    ...
    ECMAScriptParser.prototype.statement_sempred = function (_localctx, predIndex) {
        switch (predIndex) {
            case 1:
    ...
    ECMAScriptParser.prototype.continueStatement_sempred = function (_localctx, predIndex) {
        switch (predIndex) {
            case 2:
    ...
    ECMAScriptParser.prototype.breakStatement_sempred = function (_localctx, predIndex) {
        switch (predIndex) {
            case 3:
                return !this.here(ECMAScriptParser.LineTerminator);
        }
    ...
    ECMAScriptParser.prototype.returnStatement_sempred = function (_localctx, predIndex) {
        switch (predIndex) {
            case 4:
                return !this.here(ECMAScriptParser.LineTerminator);
        }
    ...
    ECMAScriptParser.prototype.throwStatement_sempred = function (_localctx, predIndex) {
        switch (predIndex) {
            case 5:
                return !this.here(ECMAScriptParser.LineTerminator);
        }
    ...
    ECMAScriptParser.prototype.singleExpression_sempred = function (_localctx, predIndex) {
        switch (predIndex) {
            case 6:
    ...
    ECMAScriptParser.prototype.getter_sempred = function (_localctx, predIndex) {
        switch (predIndex) {
            case 28:
    ...
    ECMAScriptParser.prototype.setter_sempred = function (_localctx, predIndex) {
        switch (predIndex) {
            case 29:
    ...
    ECMAScriptParser.prototype.eos_sempred = function (_localctx, predIndex) {
        switch (predIndex) {
            case 30:
    ...
    Object.defineProperty(ECMAScriptParser, "_ATN", {
        get: function () {
    ...
    ECMAScriptParser._serializedATNSegments = 2;
    ECMAScriptParser._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03i\u0272\x04\x02" +
    ...
    ECMAScriptParser._serializedATNSegment1 = "\u0230\u0231\f&\x02\x02\u0231\u0232\x07\x05\x02\x02\u0232\u0233\x05V," +
        ...
        "\u01BC\u01C2\u01CB\u01D3\u01D9\u01DD\u01E7\u0204\u0247\u0249\u0250\u0256" +
        "\u025B\u026D";
    ECMAScriptParser._serializedATN = Utils.join([
