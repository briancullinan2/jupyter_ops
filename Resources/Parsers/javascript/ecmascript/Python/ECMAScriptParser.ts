		...
		try {
			...
			case 1:
				...
				if (!(self._input.LA(1) != ECMAScriptParser.Function)) {
					throw new FailedPredicateException(this, "self._input.LA(1) != ECMAScriptParser.Function");
				}
				this.state = 121;
				this.statement();
				}
		...
		try {
			...
			case 4:
				...
				if (!(self._input.LA(1) != ECMAScriptParser.OpenBrace)) {
					throw new FailedPredicateException(this, "self._input.LA(1) != ECMAScriptParser.OpenBrace");
				}
				this.state = 129;
		...
		try {
			...
			case 1:
				...
				if (!(not self.here(ECMAScriptParser.LineTerminator))) {
					throw new FailedPredicateException(this, "not self.here(ECMAScriptParser.LineTerminator)");
				}
				this.state = 252;
				this.match(ECMAScriptParser.Identifier);
				}
	...
	public getter(): GetterContext {
		...
		try {
			...
			if (!(self._input.LT(1).text == "get")) {
				throw new FailedPredicateException(this, "self._input.LT(1).text == \"get\"");
			}
			this.state = 609;
			this.match(ECMAScriptParser.Identifier);
			this.state = 610;
	...
	public setter(): SetterContext {
		...
		try {
			...
			if (!(self._input.LT(1).text == "set")) {
				throw new FailedPredicateException(this, "self._input.LT(1).text == \"set\"");
			}
			this.state = 613;
			this.match(ECMAScriptParser.Identifier);
			this.state = 614;
		...
		try {
			...
			case 3:
				...
				if (!(self.lineTerminatorAhead())) {
					throw new FailedPredicateException(this, "self.lineTerminatorAhead()");
				}
				}
				break;
			...
			case 4:
				...
				if (!(self._input.LT(1).type == ECMAScriptParser.CloseBrace)) {
					throw new FailedPredicateException(this, "self._input.LT(1).type == ECMAScriptParser.CloseBrace");
				}
				}
				break;
			}
