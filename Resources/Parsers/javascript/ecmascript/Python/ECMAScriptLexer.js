...
next;
token.
    next = (_this = _super.call(this, ECMAScriptLexer, self) || this).nextToken();
...
;
return True;
if (self._lastToken.type == ECMAScriptLexer.Identifier)
    or;
self._lastToken.type == ECMAScriptLexer.NullLiteral;
or;
self._lastToken.type == ECMAScriptLexer.BooleanLiteral;
or;
self._lastToken.type == ECMAScriptLexer.This;
or;
self._lastToken.type == ECMAScriptLexer.CloseBracket;
or;
self._lastToken.type == ECMAScriptLexer.CloseParen;
or;
self._lastToken.type == ECMAScriptLexer.OctalIntegerLiteral;
or;
self._lastToken.type == ECMAScriptLexer.DecimalLiteral;
or;
self._lastToken.type == ECMAScriptLexer.HexIntegerLiteral;
or;
self._lastToken.type == ECMAScriptLexer.StringLiteral;
or;
self._lastToken.type == ECMAScriptLexer.PlusPlus;
or;
