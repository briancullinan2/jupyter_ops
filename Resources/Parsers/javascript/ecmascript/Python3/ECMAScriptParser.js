// Generated from C:/Users/megam/jupyter_ops/Resources/Parsers/javascript/ecmascript/Python3/ECMAScript.g4 by ANTLR 4.13.2
// jshint ignore: start
...
export default class ECMAScriptParser extends antlr4.Parser {
	    ...
	    try {
	        ...
	        case 1:
	            ...
	            if (!( self._input.LA(1) != ECMAScriptParser.Function)) {
	                throw new antlr4.error.FailedPredicateException(this, "self._input.LA(1) != ECMAScriptParser.Function");
	            }
	            this.state = 121;
	            this.statement();
	            break;
	    ...
	    try {
	        ...
	        case 4:
	            ...
	            if (!( self._input.LA(1) != ECMAScriptParser.OpenBrace)) {
	                throw new antlr4.error.FailedPredicateException(this, "self._input.LA(1) != ECMAScriptParser.OpenBrace");
	            }
	            this.state = 129;
	...
	continueStatement() {
	    ...
	    try {
	        ...
	        if(la_===1) {
	            this.state = 251;
	            if (!( not self.here(ECMAScriptParser.LineTerminator))) {
	                throw new antlr4.error.FailedPredicateException(this, "not self.here(ECMAScriptParser.LineTerminator)");
	            }
	            this.state = 252;
	            this.match(ECMAScriptParser.Identifier);
	...
	getter() {
	    ...
	    try {
	        ...
	        if (!( self._input.LT(1).text == "get")) {
	            throw new antlr4.error.FailedPredicateException(this, "self._input.LT(1).text == \"get\"");
	        }
	        this.state = 609;
	        this.match(ECMAScriptParser.Identifier);
	        this.state = 610;
	...
	setter() {
	    ...
	    try {
	        ...
	        if (!( self._input.LT(1).text == "set")) {
	            throw new antlr4.error.FailedPredicateException(this, "self._input.LT(1).text == \"set\"");
	        }
	        this.state = 613;
	        this.match(ECMAScriptParser.Identifier);
	        this.state = 614;
	    ...
	    try {
	        ...
	        case 3:
	            ...
	            if (!( self.lineTerminatorAhead())) {
	                throw new antlr4.error.FailedPredicateException(this, "self.lineTerminatorAhead()");
	            }
	            break;
	        ...
	        case 4:
	            ...
	            if (!( self._input.LT(1).type == ECMAScriptParser.CloseBrace)) {
	                throw new antlr4.error.FailedPredicateException(this, "self._input.LT(1).type == ECMAScriptParser.CloseBrace");
	            }
	            break;
