// Generated from C:/Users/megam/jupyter_ops/Resources/Parsers/javascript/ecmascript/CSharp/ECMAScript.g4 by ANTLR 4.13.2
// jshint ignore: start
	    ...
	    try {
	        ...
	        case 1:
	            ...
	            if (!( this.InputStream.LA(1) != Function)) {
	                throw new antlr4.error.FailedPredicateException(this, "this.InputStream.LA(1) != Function");
	            }
	            this.state = 121;
	            this.statement();
	            break;
	    ...
	    try {
	        ...
	        case 4:
	            ...
	            if (!( this.InputStream.LA(1) != OpenBrace)) {
	                throw new antlr4.error.FailedPredicateException(this, "this.InputStream.LA(1) != OpenBrace");
	            }
	            this.state = 129;
