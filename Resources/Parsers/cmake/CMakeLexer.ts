...
export class CMakeLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(CMakeLexer._LITERAL_NAMES, CMakeLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(CMakeLexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return CMakeLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return CMakeLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return CMakeLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return CMakeLexer.modeNames; }

	public static readonly _serializedATN: string =
		"\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\r\xAF\b\x01\x04" +
	...
	public static get _ATN(): ATN {
		if (!CMakeLexer.__ATN) {
			CMakeLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(CMakeLexer._serializedATN));
		}
