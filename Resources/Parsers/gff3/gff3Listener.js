...
// This class defines a complete listener for a parse tree produced by gff3Parser.
export default class gff3Listener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by gff3Parser#type_.
	enterType_(ctx) {
	}

	// Exit a parse tree produced by gff3Parser#type_.
	exitType_(ctx) {
	}
