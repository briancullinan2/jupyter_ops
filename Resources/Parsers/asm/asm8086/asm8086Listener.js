...
export default class asm8086Listener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by asm8086Parser#sign.
	enterSign(ctx) {
	}

	// Exit a parse tree produced by asm8086Parser#sign.
	exitSign(ctx) {
	}
