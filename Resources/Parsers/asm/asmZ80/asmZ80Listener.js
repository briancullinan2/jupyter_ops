...
// This class defines a complete listener for a parse tree produced by asmZ80Parser.
export default class asmZ80Listener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by asmZ80Parser#string_.
	enterString_(ctx) {
	}

	// Exit a parse tree produced by asmZ80Parser#string_.
	exitString_(ctx) {
	}
