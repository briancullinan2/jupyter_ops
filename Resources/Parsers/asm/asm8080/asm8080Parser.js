...
var asm8080Parser = /** @class */ (function (_super) {
    __extends(asm8080Parser, _super);
    function asm8080Parser(input) {
        var _this = _super.call(this, input) || this;
        _this._interp = new ParserATNSimulator_1.ParserATNSimulator(asm8080Parser._ATN, _this);
        return _this;
    }
    Object.defineProperty(asm8080Parser.prototype, "vocabulary", {
        // @Override
        // @NotNull
        get: function () {
    ...
    Object.defineProperty(asm8080Parser.prototype, "grammarFileName", {
    ...
    Object.defineProperty(asm8080Parser.prototype, "ruleNames", {
        // @Override
        get: function () { return asm8080Parser.ruleNames; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(asm8080Parser.prototype, "serializedATN", {
        // @Override
        get: function () { return asm8080Parser._serializedATN; },
        enumerable: true,
        configurable: true
    });
    // @RuleVersion(0)
    asm8080Parser.prototype.prog = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.line = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.instruction = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.opcode = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.register_ = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.directive = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.assemblerdirective = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.lbl = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.expressionlist = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.label = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.expression = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.multiplyingExpression = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.argument = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.dollar = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.string = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.name = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.number = function () {
    ...
    // @RuleVersion(0)
    asm8080Parser.prototype.comment = function () {
    ...
    Object.defineProperty(asm8080Parser, "_ATN", {
        get: function () {
            if (!asm8080Parser.__ATN) {
                asm8080Parser.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(asm8080Parser._serializedATN));
            }
    ...
    asm8080Parser._LITERAL_NAMES = [
        undefined, "':'", "','", "'+'", "'-'", "'*'", "'/'", "'('", "')'", "'$'",
    ];
    asm8080Parser._SYMBOLIC_NAMES = [
        undefined, undefined, undefined, undefined, undefined, undefined, undefined,
        undefined, undefined, undefined, "ASSEMBLER_DIRECTIVE", "REGISTER", "OPCODE",
        "NAME", "NUMBER", "COMMENT", "STRING", "EOL", "WS",
    ];
    asm8080Parser.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(asm8080Parser._LITERAL_NAMES, asm8080Parser._SYMBOLIC_NAMES, []);
    asm8080Parser._serializedATN = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03\x14|\x04\x02" +
    ...
    return asm8080Parser;
}(Parser_1.Parser));
exports.asm8080Parser = asm8080Parser;
var ProgContext = /** @class */ (function (_super) {
    ...
    Object.defineProperty(ProgContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_prog; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var LineContext = /** @class */ (function (_super) {
    ...
    Object.defineProperty(LineContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_line; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var InstructionContext = /** @class */ (function (_super) {
    ...
    Object.defineProperty(InstructionContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_instruction; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var OpcodeContext = /** @class */ (function (_super) {
    ...
    OpcodeContext.prototype.OPCODE = function () { return this.getToken(asm8080Parser.OPCODE, 0); };
    Object.defineProperty(OpcodeContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_opcode; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var Register_Context = /** @class */ (function (_super) {
    ...
    Register_Context.prototype.REGISTER = function () { return this.getToken(asm8080Parser.REGISTER, 0); };
    Object.defineProperty(Register_Context.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_register_; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var DirectiveContext = /** @class */ (function (_super) {
    ...
    Object.defineProperty(DirectiveContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_directive; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var AssemblerdirectiveContext = /** @class */ (function (_super) {
    ...
    AssemblerdirectiveContext.prototype.ASSEMBLER_DIRECTIVE = function () { return this.getToken(asm8080Parser.ASSEMBLER_DIRECTIVE, 0); };
    Object.defineProperty(AssemblerdirectiveContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_assemblerdirective; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var LblContext = /** @class */ (function (_super) {
    ...
    Object.defineProperty(LblContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_lbl; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var ExpressionlistContext = /** @class */ (function (_super) {
    ...
    Object.defineProperty(ExpressionlistContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_expressionlist; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var LabelContext = /** @class */ (function (_super) {
    ...
    Object.defineProperty(LabelContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_label; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var ExpressionContext = /** @class */ (function (_super) {
    ...
    Object.defineProperty(ExpressionContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_expression; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var MultiplyingExpressionContext = /** @class */ (function (_super) {
    ...
    Object.defineProperty(MultiplyingExpressionContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_multiplyingExpression; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var ArgumentContext = /** @class */ (function (_super) {
    ...
    Object.defineProperty(ArgumentContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_argument; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var DollarContext = /** @class */ (function (_super) {
    ...
    Object.defineProperty(DollarContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_dollar; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var StringContext = /** @class */ (function (_super) {
    ...
    StringContext.prototype.STRING = function () { return this.getToken(asm8080Parser.STRING, 0); };
    Object.defineProperty(StringContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_string; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var NameContext = /** @class */ (function (_super) {
    ...
    NameContext.prototype.NAME = function () { return this.getToken(asm8080Parser.NAME, 0); };
    Object.defineProperty(NameContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_name; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var NumberContext = /** @class */ (function (_super) {
    ...
    NumberContext.prototype.NUMBER = function () { return this.getToken(asm8080Parser.NUMBER, 0); };
    Object.defineProperty(NumberContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_number; },
        enumerable: true,
        configurable: true
    });
    // @Override
...
var CommentContext = /** @class */ (function (_super) {
    ...
    CommentContext.prototype.COMMENT = function () { return this.getToken(asm8080Parser.COMMENT, 0); };
    Object.defineProperty(CommentContext.prototype, "ruleIndex", {
        // @Override
        get: function () { return asm8080Parser.RULE_comment; },
        enumerable: true,
        configurable: true
    });
    // @Override
