// Generated from C:/Users/megam/jupyter_ops/Resources/Parsers/asm/asm8080/asm8080.g4 by ANTLR 4.13.2
// jshint ignore: start
import antlr4 from 'antlr4';
import asm8080Listener from './asm8080Listener.js';
...
1,0,0,0,82,83,5,12,0,0,83,7,1,0,0,0,84,85,5,11,0,0,85,9,1,0,0,0,86,88,3,
24,12,0,87,86,1,0,0,0,87,88,1,0,0,0,88,89,1,0,0,0,89,90,3,12,6,0,90,91,3,
16,8,0,91,11,1,0,0,0,92,93,5,10,0,0,93,13,1,0,0,0,94,96,3,18,9,0,95,97,5,
...
export default class asm8080Parser extends antlr4.Parser {

    static grammarFileName = "asm8080.g4";
    static literalNames = [ null, "':'", "','", "'+'", "'-'", "'*'", "'/'", 
                            "'('", "')'", "'$'" ];
    static symbolicNames = [ null, null, null, null, null, null, null, null, 
                             null, null, "ASSEMBLER_DIRECTIVE", "REGISTER", 
    ...
    constructor(input) {
        ...
        this.ruleNames = asm8080Parser.ruleNames;
        this.literalNames = asm8080Parser.literalNames;
        this.symbolicNames = asm8080Parser.symbolicNames;
    }
	...
	prog() {
	    ...
	    this.enterRule(localctx, 0, asm8080Parser.RULE_prog);
	    var _la = 0;
	    try {
	...
	line() {
	    ...
	    this.enterRule(localctx, 2, asm8080Parser.RULE_line);
	    var _la = 0;
	    try {
	        this.state = 76;
	        this._errHandler.sync(this);
	...
	instruction() {
	    ...
	    this.enterRule(localctx, 4, asm8080Parser.RULE_instruction);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 78;
	...
	opcode() {
	    ...
	    this.enterRule(localctx, 6, asm8080Parser.RULE_opcode);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 82;
	...
	register_() {
	    ...
	    this.enterRule(localctx, 8, asm8080Parser.RULE_register_);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 84;
	...
	directive() {
	    ...
	    this.enterRule(localctx, 10, asm8080Parser.RULE_directive);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 87;
	...
	assemblerdirective() {
	    ...
	    this.enterRule(localctx, 12, asm8080Parser.RULE_assemblerdirective);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 92;
	...
	lbl() {
	    ...
	    this.enterRule(localctx, 14, asm8080Parser.RULE_lbl);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 94;
	...
	expressionlist() {
	    ...
	    this.enterRule(localctx, 16, asm8080Parser.RULE_expressionlist);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 98;
	...
	label() {
	    ...
	    this.enterRule(localctx, 18, asm8080Parser.RULE_label);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 106;
	        this.name();
	...
	expression() {
	    ...
	    this.enterRule(localctx, 20, asm8080Parser.RULE_expression);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 108;
	...
	multiplyingExpression() {
	    ...
	    this.enterRule(localctx, 22, asm8080Parser.RULE_multiplyingExpression);
	    var _la = 0;
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 116;
	...
	argument() {
	    ...
	    this.enterRule(localctx, 24, asm8080Parser.RULE_argument);
	    try {
	        this.state = 133;
	        this._errHandler.sync(this);
	        switch(this._input.LA(1)) {
	...
	dollar() {
	    ...
	    this.enterRule(localctx, 26, asm8080Parser.RULE_dollar);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 135;
	...
	string_() {
	    ...
	    this.enterRule(localctx, 28, asm8080Parser.RULE_string_);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 137;
	...
	name() {
	    ...
	    this.enterRule(localctx, 30, asm8080Parser.RULE_name);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 139;
	...
	number() {
	    ...
	    this.enterRule(localctx, 32, asm8080Parser.RULE_number);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 141;
	...
	comment() {
	    ...
	    this.enterRule(localctx, 34, asm8080Parser.RULE_comment);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 143;
...
asm8080Parser.EOF = antlr4.Token.EOF;
asm8080Parser.T__0 = 1;
asm8080Parser.T__1 = 2;
asm8080Parser.T__2 = 3;
asm8080Parser.T__3 = 4;
asm8080Parser.T__4 = 5;
asm8080Parser.T__5 = 6;
asm8080Parser.T__6 = 7;
asm8080Parser.T__7 = 8;
asm8080Parser.T__8 = 9;
asm8080Parser.ASSEMBLER_DIRECTIVE = 10;
asm8080Parser.REGISTER = 11;
asm8080Parser.OPCODE = 12;
asm8080Parser.NAME = 13;
asm8080Parser.NUMBER = 14;
asm8080Parser.COMMENT = 15;
asm8080Parser.STRING = 16;
asm8080Parser.EOL = 17;
asm8080Parser.WS = 18;

asm8080Parser.RULE_prog = 0;
asm8080Parser.RULE_line = 1;
asm8080Parser.RULE_instruction = 2;
asm8080Parser.RULE_opcode = 3;
asm8080Parser.RULE_register_ = 4;
asm8080Parser.RULE_directive = 5;
asm8080Parser.RULE_assemblerdirective = 6;
asm8080Parser.RULE_lbl = 7;
asm8080Parser.RULE_expressionlist = 8;
asm8080Parser.RULE_label = 9;
asm8080Parser.RULE_expression = 10;
asm8080Parser.RULE_multiplyingExpression = 11;
asm8080Parser.RULE_argument = 12;
asm8080Parser.RULE_dollar = 13;
asm8080Parser.RULE_string_ = 14;
asm8080Parser.RULE_name = 15;
asm8080Parser.RULE_number = 16;
asm8080Parser.RULE_comment = 17;
...
class ProgContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_prog;
    }

	EOF() {
	    return this.getToken(asm8080Parser.EOF, 0);
	};
	...
	enterRule(listener) {
	    if(listener instanceof asm8080Listener ) {
...
class LineContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_line;
    }
...
class InstructionContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_instruction;
    }
...
class OpcodeContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_opcode;
    }

	OPCODE() {
	    return this.getToken(asm8080Parser.OPCODE, 0);
	};
...
class Register_Context extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_register_;
    }

	REGISTER() {
	    return this.getToken(asm8080Parser.REGISTER, 0);
	};
...
class DirectiveContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_directive;
    }
...
class AssemblerdirectiveContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_assemblerdirective;
    }

	ASSEMBLER_DIRECTIVE() {
	    return this.getToken(asm8080Parser.ASSEMBLER_DIRECTIVE, 0);
	};
...
class LblContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_lbl;
    }
...
class ExpressionlistContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_expressionlist;
    }
...
class LabelContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_label;
    }
...
class ExpressionContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_expression;
    }
...
class MultiplyingExpressionContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_multiplyingExpression;
    }
...
class ArgumentContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_argument;
    }
...
class DollarContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_dollar;
    }
...
class String_Context extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_string_;
    }

	STRING() {
	    return this.getToken(asm8080Parser.STRING, 0);
	};
...
class NameContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_name;
    }

	NAME() {
	    return this.getToken(asm8080Parser.NAME, 0);
	};
...
class NumberContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_number;
    }

	NUMBER() {
	    return this.getToken(asm8080Parser.NUMBER, 0);
	};
...
class CommentContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = asm8080Parser.RULE_comment;
    }

	COMMENT() {
	    return this.getToken(asm8080Parser.COMMENT, 0);
	};
...
asm8080Parser.ProgContext = ProgContext; 
asm8080Parser.LineContext = LineContext; 
asm8080Parser.InstructionContext = InstructionContext; 
asm8080Parser.OpcodeContext = OpcodeContext; 
asm8080Parser.Register_Context = Register_Context; 
asm8080Parser.DirectiveContext = DirectiveContext; 
asm8080Parser.AssemblerdirectiveContext = AssemblerdirectiveContext; 
asm8080Parser.LblContext = LblContext; 
asm8080Parser.ExpressionlistContext = ExpressionlistContext; 
asm8080Parser.LabelContext = LabelContext; 
asm8080Parser.ExpressionContext = ExpressionContext; 
asm8080Parser.MultiplyingExpressionContext = MultiplyingExpressionContext; 
asm8080Parser.ArgumentContext = ArgumentContext; 
asm8080Parser.DollarContext = DollarContext; 
asm8080Parser.String_Context = String_Context; 
asm8080Parser.NameContext = NameContext; 
asm8080Parser.NumberContext = NumberContext; 
asm8080Parser.CommentContext = CommentContext; 
