...
export default class asm8080Listener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by asm8080Parser#string_.
	enterString_(ctx) {
	}

	// Exit a parse tree produced by asm8080Parser#string_.
	exitString_(ctx) {
	}
