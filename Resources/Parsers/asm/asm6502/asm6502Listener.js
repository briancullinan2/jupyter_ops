...
// This class defines a complete listener for a parse tree produced by asm6502Parser.
export default class asm6502Listener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by asm6502Parser#prefix_.
	enterPrefix_(ctx) {
	}

	// Exit a parse tree produced by asm6502Parser#prefix_.
	exitPrefix_(ctx) {
	}


	// Enter a parse tree produced by asm6502Parser#string_.
	enterString_(ctx) {
	}

	// Exit a parse tree produced by asm6502Parser#string_.
	exitString_(ctx) {
	}
