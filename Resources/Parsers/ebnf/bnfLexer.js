...
export default class bnfLexer extends antlr4.Lexer {
	...
	static symbolicNames = [ null, "ASSIGN", "Right_Parenthesis", "Left_Parenthesis", 
                          "Right_Curly_Bracket", "Left_Curly_Bracket", "Right_Square_Bracket", 
                          "Left_Square_Bracket", "Vertical_Line", "Greater_Than_Sign", 
                          "Less_Than_Sign", "ID", "WS" ];
	static ruleNames = [ "ASSIGN", "Right_Parenthesis", "Left_Parenthesis", 
                      "Right_Curly_Bracket", "Left_Curly_Bracket", "Right_Square_Bracket", 
                      "Left_Square_Bracket", "Vertical_Line", "Greater_Than_Sign", 
                      "Less_Than_Sign", "ID", "WS" ];
...
bnfLexer.ASSIGN = 1;
bnfLexer.Right_Parenthesis = 2;
bnfLexer.Left_Parenthesis = 3;
bnfLexer.Right_Curly_Bracket = 4;
bnfLexer.Left_Curly_Bracket = 5;
bnfLexer.Right_Square_Bracket = 6;
bnfLexer.Left_Square_Bracket = 7;
bnfLexer.Vertical_Line = 8;
bnfLexer.Greater_Than_Sign = 9;
bnfLexer.Less_Than_Sign = 10;
bnfLexer.ID = 11;
bnfLexer.WS = 12;
