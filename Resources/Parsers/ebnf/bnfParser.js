// Generated from C:/Users/megam/jupyter_ops/Resources/Parsers/ebnf/bnf.g4 by ANTLR 4.13.2
// jshint ignore: start
...
export default class bnfParser extends antlr4.Parser {
    ...
    static literalNames = [ null, "'::='", "')'", "'('", "'}'", "'{'", "']'", 
                            "'['", "'|'", "'>'", "'<'" ];
    static symbolicNames = [ null, "ASSIGN", "Right_Parenthesis", "Left_Parenthesis", 
                             "Right_Curly_Bracket", "Left_Curly_Bracket", 
                             "Right_Square_Bracket", "Left_Square_Bracket", 
                             "Vertical_Line", "Greater_Than_Sign", "Less_Than_Sign", 
                             "ID", "WS" ];
	...
	alternatives() {
	    ...
	    try {
	        ...
	        while(_la===8) {
	            this.state = 43;
	            this.match(bnfParser.Vertical_Line);
	            this.state = 44;
	            this.alternative();
	            this.state = 49;
	            this._errHandler.sync(this);
	...
	optional_() {
	    ...
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 63;
	        this.match(bnfParser.Left_Square_Bracket);
	        this.state = 64;
	        this.alternatives();
	        this.state = 65;
	        this.match(bnfParser.Right_Square_Bracket);
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
		        localctx.exception = re;
		        this._errHandler.reportError(this, re);
	...
	zeroormore() {
	    ...
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 67;
	        this.match(bnfParser.Left_Curly_Bracket);
	        this.state = 68;
	        this.alternatives();
	        this.state = 69;
	        this.match(bnfParser.Right_Curly_Bracket);
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
		        localctx.exception = re;
		        this._errHandler.reportError(this, re);
	...
	oneormore() {
	    ...
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 71;
	        this.match(bnfParser.Left_Parenthesis);
	        this.state = 72;
	        this.alternatives();
	        this.state = 73;
	        this.match(bnfParser.Right_Parenthesis);
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
		        localctx.exception = re;
		        this._errHandler.reportError(this, re);
	...
	id_() {
	    ...
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 77;
	        this.match(bnfParser.Less_Than_Sign);
	        this.state = 78;
	        this.ruleid();
	        this.state = 79;
	        this.match(bnfParser.Greater_Than_Sign);
	    } catch (re) {
	    	if(re instanceof antlr4.error.RecognitionException) {
		        localctx.exception = re;
		        this._errHandler.reportError(this, re);
...
bnfParser.ASSIGN = 1;
bnfParser.Right_Parenthesis = 2;
bnfParser.Left_Parenthesis = 3;
bnfParser.Right_Curly_Bracket = 4;
bnfParser.Left_Curly_Bracket = 5;
bnfParser.Right_Square_Bracket = 6;
bnfParser.Left_Square_Bracket = 7;
bnfParser.Vertical_Line = 8;
bnfParser.Greater_Than_Sign = 9;
bnfParser.Less_Than_Sign = 10;
bnfParser.ID = 11;
bnfParser.WS = 12;
...
class AlternativesContext extends antlr4.ParserRuleContext {
	...
	Vertical_Line = function(i) {
	    ...
	    if(i===null) {
	        return this.getTokens(bnfParser.Vertical_Line);
	    } else {
	        return this.getToken(bnfParser.Vertical_Line, i);
	    }
	};
...
class Optional_Context extends antlr4.ParserRuleContext {
	...
	Left_Square_Bracket() {
	    return this.getToken(bnfParser.Left_Square_Bracket, 0);
	};
	...
	Right_Square_Bracket() {
	    return this.getToken(bnfParser.Right_Square_Bracket, 0);
	};
...
class ZeroormoreContext extends antlr4.ParserRuleContext {
	...
	Left_Curly_Bracket() {
	    return this.getToken(bnfParser.Left_Curly_Bracket, 0);
	};
	...
	Right_Curly_Bracket() {
	    return this.getToken(bnfParser.Right_Curly_Bracket, 0);
	};
...
class OneormoreContext extends antlr4.ParserRuleContext {
	...
	Left_Parenthesis() {
	    return this.getToken(bnfParser.Left_Parenthesis, 0);
	};
	...
	Right_Parenthesis() {
	    return this.getToken(bnfParser.Right_Parenthesis, 0);
	};
...
class Id_Context extends antlr4.ParserRuleContext {
	...
	Less_Than_Sign() {
	    return this.getToken(bnfParser.Less_Than_Sign, 0);
	};
	...
	Greater_Than_Sign() {
	    return this.getToken(bnfParser.Greater_Than_Sign, 0);
	};
