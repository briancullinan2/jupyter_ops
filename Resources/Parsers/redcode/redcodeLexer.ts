...
export class redcodeLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(redcodeLexer._LITERAL_NAMES, redcodeLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(redcodeLexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return redcodeLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return redcodeLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return redcodeLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return redcodeLexer.modeNames; }

	public static readonly _serializedATN: string =
		"\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02&\xC2\b\x01\x04" +
	...
	public static get _ATN(): ATN {
		if (!redcodeLexer.__ATN) {
			redcodeLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(redcodeLexer._serializedATN));
		}
