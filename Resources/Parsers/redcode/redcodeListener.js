...
// This class defines a complete listener for a parse tree produced by redcodeParser.
export default class redcodeListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by redcodeParser#file_.
	enterFile_(ctx) {
	}

	// Exit a parse tree produced by redcodeParser#file_.
	exitFile_(ctx) {
	}
