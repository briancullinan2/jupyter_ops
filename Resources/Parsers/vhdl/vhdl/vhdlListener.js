// Generated from C:/Users/megam/jupyter_ops/Resources/Parsers/vhdl/vhdl/vhdl.g4 by ANTLR 4.13.2
// jshint ignore: start
import antlr4 from 'antlr4';

// This class defines a complete listener for a parse tree produced by vhdlParser.
export default class vhdlListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by vhdlParser#abstract_literal.
	enterAbstract_literal(ctx) {
	}

	// Exit a parse tree produced by vhdlParser#abstract_literal.
	exitAbstract_literal(ctx) {
	}
	...
	enterConfiguration_specification(ctx) {
	}

	// Exit a parse tree produced by vhdlParser#configuration_specification.
	exitConfiguration_specification(ctx) {
	}
	...
	enterConstrained_nature_definition(ctx) {
	}

	// Exit a parse tree produced by vhdlParser#constrained_nature_definition.
	exitConstrained_nature_definition(ctx) {
	}
	...
	enterDisconnection_specification(ctx) {
	}

	// Exit a parse tree produced by vhdlParser#disconnection_specification.
	exitDisconnection_specification(ctx) {
	}
	...
	exitInterface_quantity_declaration(ctx) {
	}
	...
	exitInterface_port_declaration(ctx) {
	}
	...
	exitInterface_variable_declaration(ctx) {
	}
	...
	enterRecord_nature_definition(ctx) {
	}

	// Exit a parse tree produced by vhdlParser#record_nature_definition.
	exitRecord_nature_definition(ctx) {
	}
	...
	enterSubprogram_statement_part(ctx) {
	}

	// Exit a parse tree produced by vhdlParser#subprogram_statement_part.
	exitSubprogram_statement_part(ctx) {
	}
	...
	enterUnconstrained_nature_definition(ctx) {
	}

	// Exit a parse tree produced by vhdlParser#unconstrained_nature_definition.
	exitUnconstrained_nature_definition(ctx) {
	}
	...
	enterVariable_assignment_statement(ctx) {
	}

	// Exit a parse tree produced by vhdlParser#variable_assignment_statement.
	exitVariable_assignment_statement(ctx) {
	}
