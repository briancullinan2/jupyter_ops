// Generated from Resources/Parsers/v/V.g4 by ANTLR 4.10.1
// jshint ignore: start
import antlr4 from 'antlr4';

// This class defines a complete listener for a parse tree produced by VParser.
export default class VListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by VParser#function_.
	enterFunction_(ctx) {
	}

	// Exit a parse tree produced by VParser#function_.
	exitFunction_(ctx) {
	}
	...
	// Enter a parse tree produced by VParser#type_.
	enterType_(ctx) {
	}

	// Exit a parse tree produced by VParser#type_.
	exitType_(ctx) {
	}
