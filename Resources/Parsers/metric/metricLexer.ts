...
export class metricLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(metricLexer._LITERAL_NAMES, metricLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(metricLexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return metricLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return metricLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return metricLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return metricLexer.modeNames; }

	public static readonly _serializedATN: string =
		"\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x022\xDA\b\x01\x04" +
	...
	public static get _ATN(): ATN {
		if (!metricLexer.__ATN) {
			metricLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(metricLexer._serializedATN));
		}
