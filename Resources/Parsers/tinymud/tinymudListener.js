...
// This class defines a complete listener for a parse tree produced by tinymudParser.
export default class tinymudListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by tinymudParser#object_.
	enterObject_(ctx) {
	}

	// Exit a parse tree produced by tinymudParser#object_.
	exitObject_(ctx) {
	}
	...
	// Enter a parse tree produced by tinymudParser#dir_.
	enterDir_(ctx) {
	}

	// Exit a parse tree produced by tinymudParser#dir_.
	exitDir_(ctx) {
	}
