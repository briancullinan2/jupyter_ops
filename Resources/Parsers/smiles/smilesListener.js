...
export default class smilesListener extends antlr4.tree.ParseTreeListener {
	...
	enterElement_symbols(ctx) {
	}

	// Exit a parse tree produced by smilesParser#element_symbols.
	exitElement_symbols(ctx) {
	}


	// Enter a parse tree produced by smilesParser#aromatic_symbol.
	enterAromatic_symbol(ctx) {
	}

	// Exit a parse tree produced by smilesParser#aromatic_symbol.
	exitAromatic_symbol(ctx) {
	}
