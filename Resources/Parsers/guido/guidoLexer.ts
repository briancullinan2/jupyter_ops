...
export class guidoLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(guidoLexer._LITERAL_NAMES, guidoLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(guidoLexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return guidoLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return guidoLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return guidoLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return guidoLexer.modeNames; }

	public static readonly _serializedATN: string =
		"\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02$\xC9\b\x01\x04" +
	...
	public static get _ATN(): ATN {
		if (!guidoLexer.__ATN) {
			guidoLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(guidoLexer._serializedATN));
		}
