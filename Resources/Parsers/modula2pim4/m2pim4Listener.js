...
// This class defines a complete listener for a parse tree produced by m2pim4Parser.
export default class m2pim4Listener extends antlr4.tree.ParseTreeListener {
	...
	enterSetOrQualident(ctx) {
	}

	// Exit a parse tree produced by m2pim4Parser#setOrQualident.
	exitSetOrQualident(ctx) {
	}


	// Enter a parse tree produced by m2pim4Parser#set_.
	enterSet_(ctx) {
	}

	// Exit a parse tree produced by m2pim4Parser#set_.
	exitSet_(ctx) {
	}
	...
	// Enter a parse tree produced by m2pim4Parser#type_.
	enterType_(ctx) {
	}

	// Exit a parse tree produced by m2pim4Parser#type_.
	exitType_(ctx) {
	}
