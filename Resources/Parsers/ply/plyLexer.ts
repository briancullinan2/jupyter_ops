...
export class plyLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(plyLexer._LITERAL_NAMES, plyLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(plyLexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return plyLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return plyLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return plyLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return plyLexer.modeNames; }

	public static readonly _serializedATN: string =
		"\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\x19\xDB\b\x01" +
	...
	public static get _ATN(): ATN {
		if (!plyLexer.__ATN) {
			plyLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(plyLexer._serializedATN));
		}
