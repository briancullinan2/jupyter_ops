...
// This class defines a complete listener for a parse tree produced by robotwarParser.
export default class robotwarListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by robotwarParser#register_.
	enterRegister_(ctx) {
	}

	// Exit a parse tree produced by robotwarParser#register_.
	exitRegister_(ctx) {
	}
