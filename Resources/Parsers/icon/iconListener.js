...
// This class defines a complete listener for a parse tree produced by iconParser.
export default class iconListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by iconParser#start_.
	enterStart_(ctx) {
	}

	// Exit a parse tree produced by iconParser#start_.
	exitStart_(ctx) {
	}
	...
	// Enter a parse tree produced by iconParser#subscript_.
	enterSubscript_(ctx) {
	}

	// Exit a parse tree produced by iconParser#subscript_.
	exitSubscript_(ctx) {
	}
