// Generated from ./graphstream-dgs/DGSParser.g4 by ANTLR 4.10.1
// jshint ignore: start
import antlr4 from 'antlr4';

// This class defines a complete listener for a parse tree produced by DGSParser.
export default class DGSParserListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by DGSParser#array_.
	enterArray_(ctx) {
	}

	// Exit a parse tree produced by DGSParser#array_.
	exitArray_(ctx) {
	}
