...
// This class defines a complete listener for a parse tree produced by mumathParser.
export default class mumathListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by mumathParser#list_.
	enterList_(ctx) {
	}

	// Exit a parse tree produced by mumathParser#list_.
	exitList_(ctx) {
	}
