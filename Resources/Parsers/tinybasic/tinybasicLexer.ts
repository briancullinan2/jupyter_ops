...
export class tinybasicLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(tinybasicLexer._LITERAL_NAMES, tinybasicLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(tinybasicLexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return tinybasicLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return tinybasicLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return tinybasicLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return tinybasicLexer.modeNames; }

	public static readonly _serializedATN: string =
		"\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\x1B\x98\b\x01" +
	...
	public static get _ATN(): ATN {
		if (!tinybasicLexer.__ATN) {
			tinybasicLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(tinybasicLexer._serializedATN));
		}
