...
// This class defines a complete listener for a parse tree produced by mdxParser.
export default class mdxListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by mdxParser#mdx_statement.
	enterMdx_statement(ctx) {
	}

	// Exit a parse tree produced by mdxParser#mdx_statement.
	exitMdx_statement(ctx) {
	}
	...
	enterMember_property_definition(ctx) {
	}

	// Exit a parse tree produced by mdxParser#member_property_definition.
	exitMember_property_definition(ctx) {
	}
	...
	enterProperty_list(ctx) {
	}

	// Exit a parse tree produced by mdxParser#property_list.
	exitProperty_list(ctx) {
	}


	// Enter a parse tree produced by mdxParser#property_.
	enterProperty_(ctx) {
	}

	// Exit a parse tree produced by mdxParser#property_.
	exitProperty_(ctx) {
	}


	// Enter a parse tree produced by mdxParser#cube_specification.
	enterCube_specification(ctx) {
	}

	// Exit a parse tree produced by mdxParser#cube_specification.
	exitCube_specification(ctx) {
	}
