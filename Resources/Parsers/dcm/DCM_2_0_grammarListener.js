...
// This class defines a complete listener for a parse tree produced by DCM_2_0_grammarParser.
export default class DCM_2_0_grammarListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by DCM_2_0_grammarParser#konservierung.
	enterKonservierung(ctx) {
	}

	// Exit a parse tree produced by DCM_2_0_grammarParser#konservierung.
	exitKonservierung(ctx) {
	}
