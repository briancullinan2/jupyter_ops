...
export default class PostgreSQLParserListener extends antlr4.tree.ParseTreeListener {
	...
	enterFunction_or_procedure(ctx) {
	}
	...
	exitCluster_index_specification(ctx) {
	}
