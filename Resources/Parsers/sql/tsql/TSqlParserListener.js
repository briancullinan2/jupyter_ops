...
export default class TSqlParserListener extends antlr4.tree.ParseTreeListener {
	...
	enterFile_directory_path_separator(ctx) {
	}

	// Exit a parse tree produced by TSqlParser#file_directory_path_separator.
	exitFile_directory_path_separator(ctx) {
	}
	...
	exitMaterialized_column_definition(ctx) {
	}
	...
	enterUnary_operator_expression(ctx) {
	}

	// Exit a parse tree produced by TSqlParser#unary_operator_expression.
	exitUnary_operator_expression(ctx) {
	}
	...
	enterXml_data_type_methods(ctx) {
	}
