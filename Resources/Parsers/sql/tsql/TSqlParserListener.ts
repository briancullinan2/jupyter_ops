// Generated from /Users/briancullinan/jupyter_ops/Resources/Parsers/sql/tsql/TSqlParser.g4 by ANTLR 4.7.3-SNAPSHOT
...
import { TRY_CONVERTContext } from "./TSqlParser";
...
export interface TSqlParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the `TRY_CONVERT`
	 * labeled alternative in `TSqlParser.function_call`.
	 * @param ctx the parse tree
	 */
	enterTRY_CONVERT?: (ctx: TRY_CONVERTContext) => void;
	/**
	 * Exit a parse tree produced by the `TRY_CONVERT`
	 * labeled alternative in `TSqlParser.function_call`.
	 * @param ctx the parse tree
	 */
	exitTRY_CONVERT?: (ctx: TRY_CONVERTContext) => void;
