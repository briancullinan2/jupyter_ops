...
export class TSqlLexer extends Lexer {
	...
	public static readonly SECURITY = 303;
	public static readonly SECURITYAUDIT = 304;
	public static readonly SELECT = 305;
	public static readonly SEMANTICKEYPHRASETABLE = 306;
	public static readonly SEMANTICSIMILARITYDETAILSTABLE = 307;
	public static readonly SEMANTICSIMILARITYTABLE = 308;
	public static readonly SEQUENCE = 309;
	public static readonly SERVER = 310;
	public static readonly SERVICE = 311;
	public static readonly SERVICE_BROKER = 312;
	public static readonly SERVICE_NAME = 313;
	public static readonly SESSION = 314;
	public static readonly SESSION_USER = 315;
	public static readonly SET = 316;
	public static readonly SETUSER = 317;
	public static readonly SHUTDOWN = 318;
	public static readonly SID = 319;
	public static readonly SKIP_KEYWORD = 320;
	public static readonly SOFTNUMA = 321;
	public static readonly SOME = 322;
	public static readonly SOURCE = 323;
	public static readonly SPECIFICATION = 324;
	public static readonly SPLIT = 325;
	public static readonly SQLDUMPERFLAGS = 326;
	public static readonly SQLDUMPERPATH = 327;
	public static readonly SQLDUMPERTIMEOUT = 328;
	public static readonly STATISTICS = 329;
	public static readonly STATE = 330;
	public static readonly STATS = 331;
	public static readonly START = 332;
	public static readonly STARTED = 333;
	public static readonly STARTUP_STATE = 334;
	public static readonly STOP = 335;
	public static readonly STOPPED = 336;
	public static readonly STOP_ON_ERROR = 337;
	public static readonly SUPPORTED = 338;
	public static readonly SYSTEM = 339;
	public static readonly SYSTEM_USER = 340;
	public static readonly TABLE = 341;
	public static readonly TABLESAMPLE = 342;
	public static readonly TAPE = 343;
	public static readonly TARGET = 344;
	public static readonly TCP = 345;
	public static readonly TEXTSIZE = 346;
	public static readonly THEN = 347;
	public static readonly TO = 348;
	public static readonly TOP = 349;
	public static readonly TRACK_CAUSALITY = 350;
	public static readonly TRAN = 351;
	public static readonly TRANSACTION = 352;
	public static readonly TRANSFER = 353;
	public static readonly TRIGGER = 354;
	public static readonly TRUNCATE = 355;
	public static readonly TSEQUAL = 356;
	public static readonly UNCHECKED = 357;
	public static readonly UNION = 358;
	public static readonly UNIQUE = 359;
	public static readonly UNLOCK = 360;
	public static readonly UNPIVOT = 361;
	public static readonly UNSAFE = 362;
	public static readonly UPDATE = 363;
	public static readonly UPDATETEXT = 364;
	public static readonly URL = 365;
	public static readonly USE = 366;
	public static readonly USED = 367;
	public static readonly USER = 368;
	public static readonly VALUES = 369;
	public static readonly VARYING = 370;
	public static readonly VERBOSELOGGING = 371;
	public static readonly VIEW = 372;
	public static readonly VISIBILITY = 373;
	public static readonly WAITFOR = 374;
	public static readonly WHEN = 375;
	public static readonly WHERE = 376;
	public static readonly WHILE = 377;
	public static readonly WINDOWS = 378;
	public static readonly WITH = 379;
	public static readonly WITHIN = 380;
	public static readonly WITHOUT = 381;
	public static readonly WITNESS = 382;
	public static readonly WRITETEXT = 383;
	public static readonly ABSOLUTE = 384;
	public static readonly ACCENT_SENSITIVITY = 385;
	public static readonly ACTION = 386;
	public static readonly ACTIVATION = 387;
	public static readonly ACTIVE = 388;
	public static readonly ADDRESS = 389;
	public static readonly AES_128 = 390;
	public static readonly AES_192 = 391;
	public static readonly AES_256 = 392;
	public static readonly AFFINITY = 393;
	public static readonly AFTER = 394;
	public static readonly AGGREGATE = 395;
	public static readonly ALGORITHM = 396;
	public static readonly ALLOW_ENCRYPTED_VALUE_MODIFICATIONS = 397;
	public static readonly ALLOW_SNAPSHOT_ISOLATION = 398;
	public static readonly ALLOWED = 399;
	public static readonly ANSI_NULL_DEFAULT = 400;
	public static readonly ANSI_NULLS = 401;
	public static readonly ANSI_PADDING = 402;
	public static readonly ANSI_WARNINGS = 403;
	public static readonly APPLICATION_LOG = 404;
	public static readonly APPLY = 405;
	public static readonly ARITHABORT = 406;
	public static readonly ASSEMBLY = 407;
	public static readonly AUDIT = 408;
	public static readonly AUDIT_GUID = 409;
	public static readonly AUTO = 410;
	public static readonly AUTO_CLEANUP = 411;
	public static readonly AUTO_CLOSE = 412;
	public static readonly AUTO_CREATE_STATISTICS = 413;
	public static readonly AUTO_SHRINK = 414;
	public static readonly AUTO_UPDATE_STATISTICS = 415;
	public static readonly AUTO_UPDATE_STATISTICS_ASYNC = 416;
	public static readonly AVAILABILITY = 417;
	public static readonly AVG = 418;
	public static readonly BACKUP_PRIORITY = 419;
	public static readonly BEGIN_DIALOG = 420;
	public static readonly BIGINT = 421;
	public static readonly BINARY_BASE64 = 422;
	public static readonly BINARY_CHECKSUM = 423;
	public static readonly BINDING = 424;
	public static readonly BLOB_STORAGE = 425;
	public static readonly BROKER = 426;
	public static readonly BROKER_INSTANCE = 427;
	public static readonly BULK_LOGGED = 428;
	public static readonly CALLER = 429;
	public static readonly CAP_CPU_PERCENT = 430;
	public static readonly CAST = 431;
	public static readonly CATALOG = 432;
	public static readonly CATCH = 433;
	public static readonly CHANGE_RETENTION = 434;
	public static readonly CHANGE_TRACKING = 435;
	public static readonly CHECKSUM = 436;
	public static readonly CHECKSUM_AGG = 437;
	public static readonly CLEANUP = 438;
	public static readonly COLLECTION = 439;
	public static readonly COLUMN_MASTER_KEY = 440;
	public static readonly COMMITTED = 441;
	public static readonly COMPATIBILITY_LEVEL = 442;
	public static readonly CONCAT = 443;
	public static readonly CONCAT_NULL_YIELDS_NULL = 444;
	public static readonly CONTENT = 445;
	public static readonly CONTROL = 446;
	public static readonly COOKIE = 447;
	public static readonly COUNT = 448;
	public static readonly COUNT_BIG = 449;
	public static readonly COUNTER = 450;
	public static readonly CPU = 451;
	public static readonly CREATE_NEW = 452;
	public static readonly CREATION_DISPOSITION = 453;
	public static readonly CREDENTIAL = 454;
	public static readonly CRYPTOGRAPHIC = 455;
	public static readonly CURSOR_CLOSE_ON_COMMIT = 456;
	public static readonly CURSOR_DEFAULT = 457;
	public static readonly DATE_CORRELATION_OPTIMIZATION = 458;
	public static readonly DATEADD = 459;
	public static readonly DATEDIFF = 460;
	public static readonly DATENAME = 461;
	public static readonly DATEPART = 462;
	public static readonly DAYS = 463;
	public static readonly DB_CHAINING = 464;
	public static readonly DB_FAILOVER = 465;
	public static readonly DECRYPTION = 466;
	public static readonly DEFAULT_DOUBLE_QUOTE = 467;
	public static readonly DEFAULT_FULLTEXT_LANGUAGE = 468;
	public static readonly DEFAULT_LANGUAGE = 469;
	public static readonly DELAY = 470;
	public static readonly DELAYED_DURABILITY = 471;
	public static readonly DELETED = 472;
	public static readonly DENSE_RANK = 473;
	public static readonly DEPENDENTS = 474;
	public static readonly DES = 475;
	public static readonly DESCRIPTION = 476;
	public static readonly DESX = 477;
	public static readonly DHCP = 478;
	public static readonly DIALOG = 479;
	public static readonly DIRECTORY_NAME = 480;
	public static readonly DISABLE = 481;
	public static readonly DISABLE_BROKER = 482;
	public static readonly DISABLED = 483;
	public static readonly DISK_DRIVE = 484;
	public static readonly DOCUMENT = 485;
	public static readonly DYNAMIC = 486;
	public static readonly ELEMENTS = 487;
	public static readonly EMERGENCY = 488;
	public static readonly EMPTY = 489;
	public static readonly ENABLE = 490;
	public static readonly ENABLE_BROKER = 491;
	public static readonly ENCRYPTED_VALUE = 492;
	public static readonly ENCRYPTION = 493;
	public static readonly ENDPOINT_URL = 494;
	public static readonly ERROR_BROKER_CONVERSATIONS = 495;
	public static readonly EXCLUSIVE = 496;
	public static readonly EXECUTABLE = 497;
	public static readonly EXIST = 498;
	public static readonly EXPAND = 499;
	public static readonly EXPIRY_DATE = 500;
	public static readonly EXPLICIT = 501;
	public static readonly FAIL_OPERATION = 502;
	public static readonly FAILOVER_MODE = 503;
	public static readonly FAILURE = 504;
	public static readonly FAILURE_CONDITION_LEVEL = 505;
	public static readonly FAST = 506;
	public static readonly FAST_FORWARD = 507;
	public static readonly FILEGROUP = 508;
	public static readonly FILEGROWTH = 509;
	public static readonly FILEPATH = 510;
	public static readonly FILESTREAM = 511;
	public static readonly FILTER = 512;
	public static readonly FIRST = 513;
	public static readonly FIRST_VALUE = 514;
	public static readonly FOLLOWING = 515;
	public static readonly FORCE = 516;
	public static readonly FORCE_FAILOVER_ALLOW_DATA_LOSS = 517;
	public static readonly FORCED = 518;
	public static readonly FORMAT = 519;
	public static readonly FORWARD_ONLY = 520;
	public static readonly FULLSCAN = 521;
	public static readonly FULLTEXT = 522;
	public static readonly GB = 523;
	public static readonly GETDATE = 524;
	public static readonly GETUTCDATE = 525;
	public static readonly GLOBAL = 526;
	public static readonly GO = 527;
	public static readonly GROUP_MAX_REQUESTS = 528;
	public static readonly GROUPING = 529;
	public static readonly GROUPING_ID = 530;
	public static readonly HADR = 531;
	public static readonly HASH = 532;
	public static readonly HEALTH_CHECK_TIMEOUT = 533;
	public static readonly HIGH = 534;
	public static readonly HONOR_BROKER_PRIORITY = 535;
	public static readonly HOURS = 536;
	public static readonly IDENTITY_VALUE = 537;
	public static readonly IGNORE_NONCLUSTERED_COLUMNSTORE_INDEX = 538;
	public static readonly IMMEDIATE = 539;
	public static readonly IMPERSONATE = 540;
	public static readonly IMPORTANCE = 541;
	public static readonly INCLUDE_NULL_VALUES = 542;
	public static readonly INCREMENTAL = 543;
	public static readonly INITIATOR = 544;
	public static readonly INPUT = 545;
	public static readonly INSENSITIVE = 546;
	public static readonly INSERTED = 547;
	public static readonly INT = 548;
	public static readonly IP = 549;
	public static readonly ISOLATION = 550;
	public static readonly JOB = 551;
	public static readonly JSON = 552;
	public static readonly KB = 553;
	public static readonly KEEP = 554;
	public static readonly KEEPFIXED = 555;
	public static readonly KEY_SOURCE = 556;
	public static readonly KEYS = 557;
	public static readonly KEYSET = 558;
	public static readonly LAG = 559;
	public static readonly LAST = 560;
	public static readonly LAST_VALUE = 561;
	public static readonly LEAD = 562;
	public static readonly LEVEL = 563;
	public static readonly LIST = 564;
	public static readonly LISTENER = 565;
	public static readonly LISTENER_URL = 566;
	public static readonly LOB_COMPACTION = 567;
	public static readonly LOCAL = 568;
	public static readonly LOCATION = 569;
	public static readonly LOCK = 570;
	public static readonly LOCK_ESCALATION = 571;
	public static readonly LOGIN = 572;
	public static readonly LOOP = 573;
	public static readonly LOW = 574;
	public static readonly MANUAL = 575;
	public static readonly MARK = 576;
	public static readonly MATERIALIZED = 577;
	public static readonly MAX = 578;
	public static readonly MAX_CPU_PERCENT = 579;
	public static readonly MAX_DOP = 580;
	public static readonly MAX_FILES = 581;
	public static readonly MAX_IOPS_PER_VOLUME = 582;
	public static readonly MAX_MEMORY_PERCENT = 583;
	public static readonly MAX_PROCESSES = 584;
	public static readonly MAX_QUEUE_READERS = 585;
	public static readonly MAX_ROLLOVER_FILES = 586;
	public static readonly MAXDOP = 587;
	public static readonly MAXRECURSION = 588;
	public static readonly MAXSIZE = 589;
	public static readonly MB = 590;
	public static readonly MEDIUM = 591;
	public static readonly MEMORY_OPTIMIZED_DATA = 592;
	public static readonly MESSAGE = 593;
	public static readonly MIN = 594;
	public static readonly MIN_ACTIVE_ROWVERSION = 595;
	public static readonly MIN_CPU_PERCENT = 596;
	public static readonly MIN_IOPS_PER_VOLUME = 597;
	public static readonly MIN_MEMORY_PERCENT = 598;
	public static readonly MINUTES = 599;
	public static readonly MIRROR_ADDRESS = 600;
	public static readonly MIXED_PAGE_ALLOCATION = 601;
	public static readonly MODE = 602;
	public static readonly MODIFY = 603;
	public static readonly MOVE = 604;
	public static readonly MULTI_USER = 605;
	public static readonly NAME = 606;
	public static readonly NESTED_TRIGGERS = 607;
	public static readonly NEW_ACCOUNT = 608;
	public static readonly NEW_BROKER = 609;
	public static readonly NEW_PASSWORD = 610;
	public static readonly NEXT = 611;
	public static readonly NO = 612;
	public static readonly NO_TRUNCATE = 613;
	public static readonly NO_WAIT = 614;
	public static readonly NOCOUNT = 615;
	public static readonly NODES = 616;
	public static readonly NOEXPAND = 617;
	public static readonly NON_TRANSACTED_ACCESS = 618;
	public static readonly NORECOMPUTE = 619;
	public static readonly NORECOVERY = 620;
	public static readonly NOWAIT = 621;
	public static readonly NTILE = 622;
	public static readonly NUMANODE = 623;
	public static readonly NUMBER = 624;
	public static readonly NUMERIC_ROUNDABORT = 625;
	public static readonly OBJECT = 626;
	public static readonly OFFLINE = 627;
	public static readonly OFFSET = 628;
	public static readonly OLD_ACCOUNT = 629;
	public static readonly ONLINE = 630;
	public static readonly ONLY = 631;
	public static readonly OPEN_EXISTING = 632;
	public static readonly OPTIMISTIC = 633;
	public static readonly OPTIMIZE = 634;
	public static readonly OUT = 635;
	public static readonly OUTPUT = 636;
	public static readonly OVERRIDE = 637;
	public static readonly OWNER = 638;
	public static readonly PAGE_VERIFY = 639;
	public static readonly PARAMETERIZATION = 640;
	public static readonly PARTITION = 641;
	public static readonly PARTITIONS = 642;
	public static readonly PARTNER = 643;
	public static readonly PATH = 644;
	public static readonly POISON_MESSAGE_HANDLING = 645;
	public static readonly POOL = 646;
	public static readonly PORT = 647;
	public static readonly PRECEDING = 648;
	public static readonly PRIMARY_ROLE = 649;
	public static readonly PRIOR = 650;
	public static readonly PRIORITY = 651;
	public static readonly PRIORITY_LEVEL = 652;
	public static readonly PRIVATE = 653;
	public static readonly PRIVATE_KEY = 654;
	public static readonly PRIVILEGES = 655;
	public static readonly PROCEDURE_NAME = 656;
	public static readonly PROPERTY = 657;
	public static readonly PROVIDER = 658;
	public static readonly PROVIDER_KEY_NAME = 659;
	public static readonly QUERY = 660;
	public static readonly QUEUE = 661;
	public static readonly QUEUE_DELAY = 662;
	public static readonly QUOTED_IDENTIFIER = 663;
	public static readonly RANGE = 664;
	public static readonly RANK = 665;
	public static readonly RC2 = 666;
	public static readonly RC4 = 667;
	public static readonly RC4_128 = 668;
	public static readonly READ_COMMITTED_SNAPSHOT = 669;
	public static readonly READ_ONLY = 670;
	public static readonly READ_ONLY_ROUTING_LIST = 671;
	public static readonly READ_WRITE = 672;
	public static readonly READONLY = 673;
	public static readonly REBUILD = 674;
	public static readonly RECEIVE = 675;
	public static readonly RECOMPILE = 676;
	public static readonly RECOVERY = 677;
	public static readonly RECURSIVE_TRIGGERS = 678;
	public static readonly RELATIVE = 679;
	public static readonly REMOTE = 680;
	public static readonly REMOTE_SERVICE_NAME = 681;
	public static readonly REMOVE = 682;
	public static readonly REORGANIZE = 683;
	public static readonly REPEATABLE = 684;
	public static readonly REPLICA = 685;
	public static readonly REQUEST_MAX_CPU_TIME_SEC = 686;
	public static readonly REQUEST_MAX_MEMORY_GRANT_PERCENT = 687;
	public static readonly REQUEST_MEMORY_GRANT_TIMEOUT_SEC = 688;
	public static readonly REQUIRED_SYNCHRONIZED_SECONDARIES_TO_COMMIT = 689;
	public static readonly RESERVE_DISK_SPACE = 690;
	public static readonly RESOURCE = 691;
	public static readonly RESOURCE_MANAGER_LOCATION = 692;
	public static readonly RESTRICTED_USER = 693;
	public static readonly RETENTION = 694;
	public static readonly ROBUST = 695;
	public static readonly ROOT = 696;
	public static readonly ROUTE = 697;
	public static readonly ROW = 698;
	public static readonly ROW_NUMBER = 699;
	public static readonly ROWGUID = 700;
	public static readonly ROWS = 701;
	public static readonly SAMPLE = 702;
	public static readonly SCHEMABINDING = 703;
	public static readonly SCOPED = 704;
	public static readonly SCROLL = 705;
	public static readonly SCROLL_LOCKS = 706;
	public static readonly SEARCH = 707;
	public static readonly SECONDARY = 708;
	public static readonly SECONDARY_ONLY = 709;
	public static readonly SECONDARY_ROLE = 710;
	public static readonly SECONDS = 711;
	public static readonly SECRET = 712;
	public static readonly SECURITY_LOG = 713;
	public static readonly SEEDING_MODE = 714;
	public static readonly SELF = 715;
	public static readonly SEMI_SENSITIVE = 716;
	public static readonly SEND = 717;
	public static readonly SENT = 718;
	...
	private static readonly _serializedATNSegment3: string =
		"\u0240\x03\u0240\x03\u0240\x03\u0241\x03\u0241\x03\u0241\x03\u0241\x03" +
	...
	private static readonly _serializedATNSegment6: string =
		"\x02\x02\u02A9\u13A9\x03\x02\x02\x02\u02AB\u13B5\x03\x02\x02\x02\u02AD" +
	...
	private static readonly _serializedATNSegment8: string =
		"\x07K\x02\x02\u0B25\u0B26\x07U\x02\x02\u0B26\u0B27\x07V\x02\x02\u0B27" +
	...
	private static readonly _serializedATNSegment9: string =
		"\x02\x02\u0E42\u0E43\x07G\x02\x02\u0E43\u0186\x03\x02\x02\x02\u0E44\u0E45" +
	...
	private static readonly _serializedATNSegment10: string =
		"\u1183\u1184\x07W\x02\x02\u1184\u1185\x07T\x02\x02\u1185\u1186\x07P\x02" +
	...
	private static readonly _serializedATNSegment11: string =
		"\x07N\x02\x02\u14C5\u14C6\x07G\x02\x02\u14C6\u02F4\x03\x02\x02\x02\u14C7" +
	...
	private static readonly _serializedATNSegment13: string =
		"\u1B46\u1B47\x07W\x02\x02\u1B47\u1B48\x07N\x02\x02\u1B48\u1B49\x07N\x02" +
	...
	private static readonly _serializedATNSegment14: string =
		"\x07K\x02\x02\u1E88\u1E89\x07Q\x02\x02\u1E89\u1E8A\x07P\x02\x02\u1E8A" +
