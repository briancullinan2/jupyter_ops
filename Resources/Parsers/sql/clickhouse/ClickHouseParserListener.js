// Generated from C:/Users/megam/jupyter_ops/Resources/Parsers/sql/clickhouse/ClickHouseParser.g4 by ANTLR 4.13.2
// jshint ignore: start
...
export default class ClickHouseParserListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by ClickHouseParser#clickhouseFile.
	enterClickhouseFile(ctx) {
	}

	// Exit a parse tree produced by ClickHouseParser#clickhouseFile.
	exitClickhouseFile(ctx) {
	}


	// Enter a parse tree produced by ClickHouseParser#batch.
	enterBatch(ctx) {
	}

	// Exit a parse tree produced by ClickHouseParser#batch.
	exitBatch(ctx) {
	}


	// Enter a parse tree produced by ClickHouseParser#command.
	enterCommand(ctx) {
	}

	// Exit a parse tree produced by ClickHouseParser#command.
	exitCommand(ctx) {
	}
