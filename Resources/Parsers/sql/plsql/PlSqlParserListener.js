// Generated from C:/Users/megam/jupyter_ops/Resources/Parsers/sql/plsql/PlSqlParser.g4 by ANTLR 4.13.2
// jshint ignore: start
...
export default class PlSqlParserListener extends antlr4.tree.ParseTreeListener {
	...
	enterOverriding_procedure_spec(ctx) {
	}

	// Exit a parse tree produced by PlSqlParser#overriding_procedure_spec.
	exitOverriding_procedure_spec(ctx) {
	}
	...
	enterIndex_partitioning_values_list(ctx) {
	}

	// Exit a parse tree produced by PlSqlParser#index_partitioning_values_list.
	exitIndex_partitioning_values_list(ctx) {
	}
	...
	enterParallel_instances_clause(ctx) {
	}

	// Exit a parse tree produced by PlSqlParser#parallel_instances_clause.
	exitParallel_instances_clause(ctx) {
	}
	...
	enterDrop_materialized_view_log(ctx) {
	}

	// Exit a parse tree produced by PlSqlParser#drop_materialized_view_log.
	exitDrop_materialized_view_log(ctx) {
	}
	...
	enterVirtual_column_expression(ctx) {
	}

	// Exit a parse tree produced by PlSqlParser#virtual_column_expression.
	exitVirtual_column_expression(ctx) {
	}
	...
	enterBy_user_for_statistics_clause(ctx) {
	}

	// Exit a parse tree produced by PlSqlParser#by_user_for_statistics_clause.
	exitBy_user_for_statistics_clause(ctx) {
	}
	...
	enterTable_ref_aux_internal_thre(ctx) {
	}

	// Exit a parse tree produced by PlSqlParser#table_ref_aux_internal_thre.
	exitTable_ref_aux_internal_thre(ctx) {
	}
	...
	enterNon_reserved_keywords_in_18c(ctx) {
	}

	// Exit a parse tree produced by PlSqlParser#non_reserved_keywords_in_18c.
	exitNon_reserved_keywords_in_18c(ctx) {
	}
