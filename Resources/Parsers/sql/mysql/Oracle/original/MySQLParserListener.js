// Generated from C:/Users/megam/jupyter_ops/Resources/Parsers/sql/mysql/Oracle/original/MySQLParser.g4 by ANTLR 4.13.2
// jshint ignore: start
...
export default class MySQLParserListener extends antlr4.tree.ParseTreeListener {
	...
	enterTriggerFollowsPrecedesClause(ctx) {
	}

	// Exit a parse tree produced by MySQLParser#triggerFollowsPrecedesClause.
	exitTriggerFollowsPrecedesClause(ctx) {
	}
	...
	exitTransactionOrLockingStatement(ctx) {
	}
	...
	enterStartTransactionOptionList(ctx) {
	}

	// Exit a parse tree produced by MySQLParser#startTransactionOptionList.
	exitStartTransactionOptionList(ctx) {
	}
	...
	enterSimpleExprUserVariableAssignment(ctx) {
	}

	// Exit a parse tree produced by MySQLParser#simpleExprUserVariableAssignment.
	exitSimpleExprUserVariableAssignment(ctx) {
	}
	...
	enterFunctionDatetimePrecision(ctx) {
	}

	// Exit a parse tree produced by MySQLParser#functionDatetimePrecision.
	exitFunctionDatetimePrecision(ctx) {
	}
