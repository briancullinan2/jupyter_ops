// Generated from C:/Users/megam/jupyter_ops/Resources/Parsers/sql/mysql/Positive-Technologies/MySqlParser.g4 by ANTLR 4.13.2
// jshint ignore: start
...
export default class MySqlParserListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by MySqlParser#clusteringKeyColumnConstraint.
	enterClusteringKeyColumnConstraint(ctx) {
	}

	// Exit a parse tree produced by MySqlParser#clusteringKeyColumnConstraint.
	exitClusteringKeyColumnConstraint(ctx) {
	}
	...
	// Enter a parse tree produced by MySqlParser#clusteringKeyTableConstraint.
	enterClusteringKeyTableConstraint(ctx) {
	}

	// Exit a parse tree produced by MySqlParser#clusteringKeyTableConstraint.
	exitClusteringKeyTableConstraint(ctx) {
	}
	...
	// Enter a parse tree produced by MySqlParser#tableOptionSecondaryEngine.
	enterTableOptionSecondaryEngine(ctx) {
	}

	// Exit a parse tree produced by MySqlParser#tableOptionSecondaryEngine.
	exitTableOptionSecondaryEngine(ctx) {
	}
	...
	// Enter a parse tree produced by MySqlParser#sequenceTableItem.
	enterSequenceTableItem(ctx) {
	}

	// Exit a parse tree produced by MySqlParser#sequenceTableItem.
	exitSequenceTableItem(ctx) {
	}
