...
// This class defines a complete listener for a parse tree produced by gmlParser.
export default class gmlListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by gmlParser#list_.
	enterList_(ctx) {
	}

	// Exit a parse tree produced by gmlParser#list_.
	exitList_(ctx) {
	}
	...
	// Enter a parse tree produced by gmlParser#str_.
	enterStr_(ctx) {
	}

	// Exit a parse tree produced by gmlParser#str_.
	exitStr_(ctx) {
	}
