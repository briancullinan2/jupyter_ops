...
// This class defines a complete listener for a parse tree produced by RegoParser.
export default class RegoParserListener extends antlr4.tree.ParseTreeListener {
	...
	enterNonEmptyBraceEnclosedBody(ctx) {
	}

	// Exit a parse tree produced by RegoParser#nonEmptyBraceEnclosedBody.
	exitNonEmptyBraceEnclosedBody(ctx) {
	}
	...
	// Enter a parse tree produced by RegoParser#array_.
	enterArray_(ctx) {
	}

	// Exit a parse tree produced by RegoParser#array_.
	exitArray_(ctx) {
	}


	// Enter a parse tree produced by RegoParser#set_.
	enterSet_(ctx) {
	}

	// Exit a parse tree produced by RegoParser#set_.
	exitSet_(ctx) {
	}
