...
var pl0Lexer = /** @class */ (function (_super) {
    __extends(pl0Lexer, _super);
    // tslint:enable:no-trailing-whitespace
    function pl0Lexer(input) {
        var _this = _super.call(this, input) || this;
        _this._interp = new LexerATNSimulator_1.LexerATNSimulator(pl0Lexer._ATN, _this);
        return _this;
    }
    Object.defineProperty(pl0Lexer.prototype, "vocabulary", {
        // @Override
        // @NotNull
        get: function () {
    ...
    Object.defineProperty(pl0Lexer.prototype, "grammarFileName", {
        // @Override
        get: function () { return "pl0.g4"; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(pl0Lexer.prototype, "ruleNames", {
        // @Override
        get: function () { return pl0Lexer.ruleNames; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(pl0Lexer.prototype, "serializedATN", {
        // @Override
        get: function () { return pl0Lexer._serializedATN; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(pl0Lexer.prototype, "channelNames", {
        // @Override
        get: function () { return pl0Lexer.channelNames; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(pl0Lexer.prototype, "modeNames", {
        // @Override
        get: function () { return pl0Lexer.modeNames; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(pl0Lexer, "_ATN", {
        get: function () {
            if (!pl0Lexer.__ATN) {
                pl0Lexer.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(pl0Lexer._serializedATN));
            }
    ...
    pl0Lexer._LITERAL_NAMES = [
        undefined, "'.'", "'='", "','", "';'", "':='", "'?'", "'!'", "'#'", "'<'",
        "'<='", "'>'", "'>='", "'+'", "'-'", "'*'", "'/'", "'('", "')'",
    ];
    pl0Lexer._SYMBOLIC_NAMES = [
    ...
    pl0Lexer.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(pl0Lexer._LITERAL_NAMES, pl0Lexer._SYMBOLIC_NAMES, []);
    pl0Lexer._serializedATN = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02#\u0122\b\x01" +
