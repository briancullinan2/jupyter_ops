...
export default class pl0Listener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by pl0Parser#vars_.
	enterVars_(ctx) {
	}

	// Exit a parse tree produced by pl0Parser#vars_.
	exitVars_(ctx) {
	}
