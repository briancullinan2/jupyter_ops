...
export default class lolcodeListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by lolcodeParser#all_.
	enterAll_(ctx) {
	}

	// Exit a parse tree produced by lolcodeParser#all_.
	exitAll_(ctx) {
	}


	// Enter a parse tree produced by lolcodeParser#any_.
	enterAny_(ctx) {
	}

	// Exit a parse tree produced by lolcodeParser#any_.
	exitAny_(ctx) {
	}


	// Enter a parse tree produced by lolcodeParser#not_.
	enterNot_(ctx) {
	}

	// Exit a parse tree produced by lolcodeParser#not_.
	exitNot_(ctx) {
	}


	// Enter a parse tree produced by lolcodeParser#func_.
	enterFunc_(ctx) {
	}

	// Exit a parse tree produced by lolcodeParser#func_.
	exitFunc_(ctx) {
	}
