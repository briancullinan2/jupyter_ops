// Generated from C:/Users/megam/jupyter_ops/Resources/Parsers/icalendar/ICalendar.g4 by ANTLR 4.13.2
// jshint ignore: start
import antlr4 from 'antlr4';

// This class defines a complete listener for a parse tree produced by ICalendarParser.
export default class ICalendarListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by ICalendarParser#repeat_.
	enterRepeat_(ctx) {
	}

	// Exit a parse tree produced by ICalendarParser#repeat_.
	exitRepeat_(ctx) {
	}
	...
	// Enter a parse tree produced by ICalendarParser#bool_.
	enterBool_(ctx) {
	}

	// Exit a parse tree produced by ICalendarParser#bool_.
	exitBool_(ctx) {
	}


	// Enter a parse tree produced by ICalendarParser#cal_address.
	enterCal_address(ctx) {
	}
