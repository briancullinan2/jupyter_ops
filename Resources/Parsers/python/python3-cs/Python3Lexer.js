"use strict";
// Generated from /Users/briancullinan/jupyter_ops/Resources/Parsers/python/python3-cs/Python3.g4 by ANTLR 4.7.3-SNAPSHOT
...
var Python3Lexer = /** @class */ (function (_super) {
    ...
    function Python3Lexer() {
        ...
        _this.Tokens = new System.Collections.Generic.LinkedList();
        _this.Indents = new System.Collections.Generic.Stack();
        _this.Opened = 0;
...
CommonToken(int, type, string, text);
{
    ...
    stop = CharIndex - 1;
    int;
    start = text.Length == 0 ? stop : stop - text.Length + 1;
...
int;
GetIndentationCount(string, spaces);
{
    int;
    count = 0;
...
}
{
    ...
    int;
    previous = Indents.Count == 0 ? 0 : Indents.Peek();
    if (indent == previous) {
