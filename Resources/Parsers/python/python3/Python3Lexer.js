...
var Python3Lexer = /** @class */ (function (_super) {
    ...
    Python3Lexer.prototype.emit = function (Token, t) {
    ...
    Python3Lexer.prototype.commonToken = function (int, type, String, text) {
        int;
    ...
    Python3Lexer.prototype.getIndentationCount = function (String, spaces) {
        int;
        count = 0;
        for (char; ch; )
            : spaces.toCharArray();
    ...
    ], Python3Lexer.prototype, "void", void 0);
    __decorate([
        Decorators_1.Override
    ], Python3Lexer.prototype, "Token", void 0);
    return Python3Lexer;
}(Lexer_1.Lexer));
