...
var CommonToken_1 = require("antlr4ts/CommonToken");
...
var Python3Lexer = /** @class */ (function (_super) {
    ...
    ;
    Python3Lexer.prototype.emit = function (token) {
        if (token) {
            token = _super.prototype.emit.call(this, token);
        }
        else {
            token = _super.prototype.emit.call(this);
        }
    ...
    Python3Lexer.prototype.nextToken = function () {
        ...
        var next = _super.prototype.nextToken.call(this);
    ...
    Python3Lexer.prototype.createDedent = function () {
        var dedent = this.commonToken(Python3Parser_1.Python3Parser.DEDENT, "");
        if (this.last_token) {
    ...
    // @Override
    Python3Lexer.prototype.action = function (_localctx, ruleIndex, actionIndex) {
        switch (ruleIndex) {
            case 33:
    ...
    Python3Lexer.prototype.NEWLINE_action = function (_localctx, actionIndex) {
        switch (actionIndex) {
            case 0:
                ...
                var nextnext = this.inputStream.LA(2);
    ...
    Python3Lexer.prototype.OPEN_PAREN_action = function (_localctx, actionIndex) {
        switch (actionIndex) {
            case 1:
                this.opened++;
                break;
    ...
    Python3Lexer.prototype.CLOSE_PAREN_action = function (_localctx, actionIndex) {
        switch (actionIndex) {
            case 2:
                this.opened--;
                break;
    ...
    Python3Lexer.prototype.OPEN_BRACK_action = function (_localctx, actionIndex) {
        switch (actionIndex) {
            case 3:
                this.opened++;
                break;
    ...
    Python3Lexer.prototype.CLOSE_BRACK_action = function (_localctx, actionIndex) {
        switch (actionIndex) {
            case 4:
                this.opened--;
                break;
    ...
    Python3Lexer.prototype.OPEN_BRACE_action = function (_localctx, actionIndex) {
        switch (actionIndex) {
            case 5:
                this.opened++;
                break;
    ...
    Python3Lexer.prototype.CLOSE_BRACE_action = function (_localctx, actionIndex) {
        switch (actionIndex) {
            case 6:
                this.opened--;
                break;
    ...
    // @Override
    Python3Lexer.prototype.sempred = function (_localctx, ruleIndex, predIndex) {
        switch (ruleIndex) {
            case 33:
    ...
    Python3Lexer.prototype.NEWLINE_sempred = function (_localctx, predIndex) {
        switch (predIndex) {
            case 0:
    ...
    Python3Lexer._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02^\u0347\b\x01" +
    ...
    Python3Lexer._serializedATNSegment1 = "\u0152\x07j\x02\x02\u0152&\x03\x02\x02\x02\u0153\u0154\x07g\x02\x02\u0154" +
