"use strict";
// Generated from /Users/briancullinan/jupyter_ops/Resources/Parsers/python/python3-js/Python3.g4 by ANTLR 4.7.3-SNAPSHOT
...
exports.Python3Lexer = Python3Lexer = function () {
...
void {
    ...
    case: 0,
    let: let, newLine: newLine,
    let: let, spaces: spaces,
    // Strip newlines inside open clauses except if we are near EOF. We keep NEWLINEs near EOF to
    // satisfy the final newline needed by the single_put rule used by the REPL.
    let: let, next: next,
    let: let, nextnext: nextnext,
    : .opened > 0 || (nextnext != -1 /* EOF */ && (next === 13 /* '\r' */ || next === 10 /* '\n' */ || next === 35 /* '#' */))
};
{
