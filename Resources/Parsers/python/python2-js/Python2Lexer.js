...
var IndentStack = /** @class */ (function () {
    ...
    IndentStack.prototype.empty = function () {
        return this._s.length === 0;
    };
    IndentStack.prototype.push = function (wsval) {
        this._s.push(wsval);
    };
    IndentStack.prototype.pop = function () {
        this._s.pop();
    };
    IndentStack.prototype.wsval = function () {
        if (this._s.length)
...
var TokenQueue = /** @class */ (function () {
    ...
    TokenQueue.prototype.empty = function () {
        return this._q.length === 0;
    };
    TokenQueue.prototype.enq = function (t) {
        this._q.push(t);
    };
    TokenQueue.prototype.deq = function () {
...
exports.Python2Lexer = Python2Lexer = function () {
...
void {
    ...
    break: ,
    case: 2,
    : ._openBRCount == 0 && !this._lineContinuation
};
{
    if (!this._suppressNewlines) {
        this.emitNewline();
...
void {
    ...
    case: 3,
    : ._tokenStartColumn == 0 && this._openBRCount == 0
