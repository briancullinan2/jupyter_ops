 ...
 * `AltPython3Parser`.
 */
export interface AltPython3Listener extends ParseTreeListener {
	/**
	...
	/**
	 * Enter a parse tree produced by `AltPython3Parser.subscript`.
	 * @param ctx the parse tree
	 */
	enterSubscript?: (ctx: SubscriptContext) => void;
	/**
	 * Exit a parse tree produced by `AltPython3Parser.subscript`.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by `AltPython3Parser.str`.
	 * @param ctx the parse tree
	 */
	enterStr?: (ctx: StrContext) => void;
	/**
	 * Exit a parse tree produced by `AltPython3Parser.str`.
	 * @param ctx the parse tree
	 */
