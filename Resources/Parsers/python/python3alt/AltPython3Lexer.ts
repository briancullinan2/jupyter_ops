...
export class AltPython3Lexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(AltPython3Lexer._LITERAL_NAMES, AltPython3Lexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(AltPython3Lexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return AltPython3Lexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return AltPython3Lexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return AltPython3Lexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return AltPython3Lexer.modeNames; }
	...
	public static get _ATN(): ATN {
		if (!AltPython3Lexer.__ATN) {
			AltPython3Lexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(AltPython3Lexer._serializedATN));
		}
