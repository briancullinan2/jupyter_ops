"use strict";
// Generated from /Users/briancullinan/jupyter_ops/Resources/Parsers/typescript/TypeScriptLexer.g4 by ANTLR 4.7.3-SNAPSHOT
...
var TypeScriptLexer = /** @class */ (function (_super) {
    __extends(TypeScriptLexer, _super);
    // tslint:enable:no-trailing-whitespace
    function TypeScriptLexer(input) {
        var _this = _super.call(this, input) || this;
        _this._interp = new LexerATNSimulator_1.LexerATNSimulator(TypeScriptLexer._ATN, _this);
        return _this;
    }
    Object.defineProperty(TypeScriptLexer.prototype, "vocabulary", {
        // @Override
        // @NotNull
        get: function () {
    ...
    Object.defineProperty(TypeScriptLexer.prototype, "grammarFileName", {
        // @Override
        get: function () { return "TypeScriptLexer.g4"; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TypeScriptLexer.prototype, "ruleNames", {
        // @Override
        get: function () { return TypeScriptLexer.ruleNames; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TypeScriptLexer.prototype, "serializedATN", {
        // @Override
        get: function () { return TypeScriptLexer._serializedATN; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TypeScriptLexer.prototype, "channelNames", {
        // @Override
        get: function () { return TypeScriptLexer.channelNames; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TypeScriptLexer.prototype, "modeNames", {
        // @Override
        get: function () { return TypeScriptLexer.modeNames; },
        enumerable: true,
        configurable: true
    });
    // @Override
    TypeScriptLexer.prototype.action = function (_localctx, ruleIndex, actionIndex) {
        switch (ruleIndex) {
            case 7:
    ...
    TypeScriptLexer.prototype.OpenBrace_action = function (_localctx, actionIndex) {
        switch (actionIndex) {
            case 0:
    ...
    TypeScriptLexer.prototype.CloseBrace_action = function (_localctx, actionIndex) {
        switch (actionIndex) {
            case 1:
    ...
    TypeScriptLexer.prototype.StringLiteral_action = function (_localctx, actionIndex) {
        switch (actionIndex) {
            case 2:
    ...
    // @Override
    TypeScriptLexer.prototype.sempred = function (_localctx, ruleIndex, predIndex) {
        switch (ruleIndex) {
            case 2:
    ...
    TypeScriptLexer.prototype.RegularExpressionLiteral_sempred = function (_localctx, predIndex) {
        switch (predIndex) {
            case 0:
    ...
    TypeScriptLexer.prototype.OctalIntegerLiteral_sempred = function (_localctx, predIndex) {
        switch (predIndex) {
            case 1:
    ...
    Object.defineProperty(TypeScriptLexer, "_ATN", {
        get: function () {
            if (!TypeScriptLexer.__ATN) {
                TypeScriptLexer.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(TypeScriptLexer._serializedATN));
            }
    ...
    TypeScriptLexer.CloseBrace = 9;
    TypeScriptLexer.SemiColon = 10;
    TypeScriptLexer.Comma = 11;
    TypeScriptLexer.Assign = 12;
    TypeScriptLexer.QuestionMark = 13;
    TypeScriptLexer.Colon = 14;
    TypeScriptLexer.Ellipsis = 15;
    TypeScriptLexer.Dot = 16;
    TypeScriptLexer.PlusPlus = 17;
    TypeScriptLexer.MinusMinus = 18;
    TypeScriptLexer.Plus = 19;
    TypeScriptLexer.Minus = 20;
    TypeScriptLexer.BitNot = 21;
    TypeScriptLexer.Not = 22;
    TypeScriptLexer.Multiply = 23;
    TypeScriptLexer.Divide = 24;
    TypeScriptLexer.Modulus = 25;
    TypeScriptLexer.RightShiftArithmetic = 26;
    TypeScriptLexer.LeftShiftArithmetic = 27;
    TypeScriptLexer.RightShiftLogical = 28;
    TypeScriptLexer.LessThan = 29;
    TypeScriptLexer.MoreThan = 30;
    TypeScriptLexer.LessThanEquals = 31;
    TypeScriptLexer.GreaterThanEquals = 32;
    TypeScriptLexer.Equals_ = 33;
    TypeScriptLexer.NotEquals = 34;
    TypeScriptLexer.IdentityEquals = 35;
    TypeScriptLexer.IdentityNotEquals = 36;
    TypeScriptLexer.BitAnd = 37;
    TypeScriptLexer.BitXOr = 38;
    TypeScriptLexer.BitOr = 39;
    TypeScriptLexer.And = 40;
    TypeScriptLexer.Or = 41;
    TypeScriptLexer.MultiplyAssign = 42;
    TypeScriptLexer.DivideAssign = 43;
    TypeScriptLexer.ModulusAssign = 44;
    TypeScriptLexer.PlusAssign = 45;
    TypeScriptLexer.MinusAssign = 46;
    TypeScriptLexer.LeftShiftArithmeticAssign = 47;
    TypeScriptLexer.RightShiftArithmeticAssign = 48;
    TypeScriptLexer.RightShiftLogicalAssign = 49;
    TypeScriptLexer.BitAndAssign = 50;
    TypeScriptLexer.BitXorAssign = 51;
    TypeScriptLexer.BitOrAssign = 52;
    TypeScriptLexer.ARROW = 53;
    TypeScriptLexer.NullLiteral = 54;
    TypeScriptLexer.BooleanLiteral = 55;
    TypeScriptLexer.DecimalLiteral = 56;
    TypeScriptLexer.HexIntegerLiteral = 57;
    TypeScriptLexer.OctalIntegerLiteral = 58;
    TypeScriptLexer.OctalIntegerLiteral2 = 59;
    TypeScriptLexer.BinaryIntegerLiteral = 60;
    TypeScriptLexer.Break = 61;
    TypeScriptLexer.Do = 62;
    TypeScriptLexer.Instanceof = 63;
    TypeScriptLexer.Typeof = 64;
    TypeScriptLexer.Case = 65;
    TypeScriptLexer.Else = 66;
    TypeScriptLexer.New = 67;
    TypeScriptLexer.Var = 68;
    TypeScriptLexer.Catch = 69;
    TypeScriptLexer.Finally = 70;
    TypeScriptLexer.Return = 71;
    TypeScriptLexer.Void = 72;
    TypeScriptLexer.Continue = 73;
    TypeScriptLexer.For = 74;
    TypeScriptLexer.Switch = 75;
    TypeScriptLexer.While = 76;
    TypeScriptLexer.Debugger = 77;
    TypeScriptLexer.Function = 78;
    TypeScriptLexer.This = 79;
    TypeScriptLexer.With = 80;
    TypeScriptLexer.Default = 81;
    TypeScriptLexer.If = 82;
    TypeScriptLexer.Throw = 83;
    TypeScriptLexer.Delete = 84;
    TypeScriptLexer.In = 85;
    TypeScriptLexer.Try = 86;
    TypeScriptLexer.As = 87;
    TypeScriptLexer.From = 88;
    TypeScriptLexer.ReadOnly = 89;
    TypeScriptLexer.Async = 90;
    TypeScriptLexer.Class = 91;
    TypeScriptLexer.Enum = 92;
    TypeScriptLexer.Extends = 93;
    TypeScriptLexer.Super = 94;
    TypeScriptLexer.Const = 95;
    TypeScriptLexer.Export = 96;
    TypeScriptLexer.Import = 97;
    TypeScriptLexer.Implements = 98;
    TypeScriptLexer.Let = 99;
    TypeScriptLexer.Private = 100;
    TypeScriptLexer.Public = 101;
    TypeScriptLexer.Interface = 102;
    TypeScriptLexer.Package = 103;
    TypeScriptLexer.Protected = 104;
    TypeScriptLexer.Static = 105;
    TypeScriptLexer.Yield = 106;
    TypeScriptLexer.Any = 107;
    TypeScriptLexer.Number = 108;
    TypeScriptLexer.Boolean = 109;
    TypeScriptLexer.String = 110;
    TypeScriptLexer.Symbol = 111;
    TypeScriptLexer.Type = 112;
    TypeScriptLexer.Get = 113;
    TypeScriptLexer.Set = 114;
    TypeScriptLexer.Constructor = 115;
    TypeScriptLexer.Namespace = 116;
    TypeScriptLexer.Require = 117;
    TypeScriptLexer.Module = 118;
    TypeScriptLexer.Declare = 119;
    TypeScriptLexer.Abstract = 120;
    TypeScriptLexer.Is = 121;
    TypeScriptLexer.At = 122;
    TypeScriptLexer.Identifier = 123;
    TypeScriptLexer.StringLiteral = 124;
    TypeScriptLexer.TemplateStringLiteral = 125;
    TypeScriptLexer.WhiteSpaces = 126;
    TypeScriptLexer.LineTerminator = 127;
    TypeScriptLexer.HtmlComment = 128;
    TypeScriptLexer.CDataComment = 129;
    TypeScriptLexer.UnexpectedCharacter = 130;
    TypeScriptLexer.ERROR = 2;
    // tslint:disable:no-trailing-whitespace
    TypeScriptLexer.channelNames = [
        "DEFAULT_TOKEN_CHANNEL", "HIDDEN", "ERROR",
    ];
    // tslint:disable:no-trailing-whitespace
    TypeScriptLexer.modeNames = [
        "DEFAULT_MODE",
    ];
    ...
    TypeScriptLexer._LITERAL_NAMES = [
    ...
    TypeScriptLexer._SYMBOLIC_NAMES = [
    ...
    TypeScriptLexer.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(TypeScriptLexer._LITERAL_NAMES, TypeScriptLexer._SYMBOLIC_NAMES, []);
    TypeScriptLexer._serializedATNSegments = 3;
    TypeScriptLexer._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\x84\u049F\b\x01" +
        ...
        "\x02\x02\x02";
    TypeScriptLexer._serializedATNSegment1 = "u\u0219\x03\x02\x02\x02w\u0221\x03\x02\x02\x02y\u0228\x03\x02\x02\x02" +
        ...
        "\u03FF\u0400";
    TypeScriptLexer._serializedATNSegment2 = "\x07@\x02\x02\u0400\u0401\x03\x02\x02\x02\u0401\u0402\b\x81\x02\x02\u0402" +
    ...
    TypeScriptLexer._serializedATN = Utils.join([
...
exports.TypeScriptLexer = TypeScriptLexer;
