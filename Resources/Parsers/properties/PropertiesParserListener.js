...
export default class PropertiesParserListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by PropertiesParser#propertiesFile.
	enterPropertiesFile(ctx) {
	}

	// Exit a parse tree produced by PropertiesParser#propertiesFile.
	exitPropertiesFile(ctx) {
	}
