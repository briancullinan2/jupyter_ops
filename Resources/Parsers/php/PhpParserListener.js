...
export default class PhpParserListener extends antlr4.tree.ParseTreeListener {
	...
	enterTypeParameterWithDefaultsList(ctx) {
	}

	// Exit a parse tree produced by PhpParser#typeParameterWithDefaultsList.
	exitTypeParameterWithDefaultsList(ctx) {
	}
	...
	enterBackQuoteStringExpression(ctx) {
	}

	// Exit a parse tree produced by PhpParser#BackQuoteStringExpression.
	exitBackQuoteStringExpression(ctx) {
	}
	...
	enterPostfixIncDecExpression(ctx) {
	}

	// Exit a parse tree produced by PhpParser#PostfixIncDecExpression.
	exitPostfixIncDecExpression(ctx) {
	}
	...
	exitLambdaFunctionExpression(ctx) {
	}
