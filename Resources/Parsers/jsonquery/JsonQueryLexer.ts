...
export class JsonQueryLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(JsonQueryLexer._LITERAL_NAMES, JsonQueryLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(JsonQueryLexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return JsonQueryLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return JsonQueryLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return JsonQueryLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return JsonQueryLexer.modeNames; }
	...
	public static get _ATN(): ATN {
		if (!JsonQueryLexer.__ATN) {
			JsonQueryLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(JsonQueryLexer._serializedATN));
		}
