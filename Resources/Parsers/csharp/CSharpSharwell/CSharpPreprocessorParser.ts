...
export class CSharpPreprocessorParser extends Parser {
	...
	public static readonly VIRTUAL = 104;
	public static readonly VOID = 105;
	public static readonly VOLATILE = 106;
	public static readonly WHEN = 107;
	public static readonly WHERE = 108;
	public static readonly WHILE = 109;
	public static readonly YIELD = 110;
	public static readonly IDENTIFIER = 111;
	public static readonly LITERAL_ACCESS = 112;
	public static readonly INTEGER_LITERAL = 113;
	public static readonly HEX_INTEGER_LITERAL = 114;
	public static readonly REAL_LITERAL = 115;
	public static readonly CHARACTER_LITERAL = 116;
	public static readonly REGULAR_STRING = 117;
	public static readonly VERBATIUM_STRING = 118;
	public static readonly INTERPOLATED_REGULAR_STRING_START = 119;
	public static readonly INTERPOLATED_VERBATIUM_STRING_START = 120;
	public static readonly OPEN_BRACE = 121;
	public static readonly CLOSE_BRACE = 122;
	public static readonly OPEN_BRACKET = 123;
	public static readonly CLOSE_BRACKET = 124;
	public static readonly OPEN_PARENS = 125;
	public static readonly CLOSE_PARENS = 126;
	...
	public static readonly MINUS = 132;
	public static readonly STAR = 133;
	public static readonly DIV = 134;
	public static readonly PERCENT = 135;
	public static readonly AMP = 136;
	public static readonly BITWISE_OR = 137;
	public static readonly CARET = 138;
	public static readonly BANG = 139;
	public static readonly TILDE = 140;
	public static readonly ASSIGNMENT = 141;
	public static readonly LT = 142;
	public static readonly GT = 143;
	public static readonly INTERR = 144;
	public static readonly DOUBLE_COLON = 145;
	public static readonly OP_COALESCING = 146;
	public static readonly OP_INC = 147;
	public static readonly OP_DEC = 148;
	public static readonly OP_AND = 149;
	public static readonly OP_OR = 150;
	public static readonly OP_PTR = 151;
	public static readonly OP_EQ = 152;
	public static readonly OP_NE = 153;
	public static readonly OP_LE = 154;
	public static readonly OP_GE = 155;
	public static readonly OP_ADD_ASSIGNMENT = 156;
	public static readonly OP_SUB_ASSIGNMENT = 157;
	public static readonly OP_MULT_ASSIGNMENT = 158;
	public static readonly OP_DIV_ASSIGNMENT = 159;
	public static readonly OP_MOD_ASSIGNMENT = 160;
	public static readonly OP_AND_ASSIGNMENT = 161;
	public static readonly OP_OR_ASSIGNMENT = 162;
	public static readonly OP_XOR_ASSIGNMENT = 163;
	public static readonly OP_LEFT_SHIFT = 164;
	public static readonly OP_LEFT_SHIFT_ASSIGNMENT = 165;
	public static readonly DOUBLE_CURLY_INSIDE = 166;
	public static readonly OPEN_BRACE_INSIDE = 167;
	public static readonly REGULAR_CHAR_INSIDE = 168;
	public static readonly VERBATIUM_DOUBLE_QUOTE_INSIDE = 169;
	public static readonly DOUBLE_QUOTE_INSIDE = 170;
	public static readonly REGULAR_STRING_INSIDE = 171;
	public static readonly VERBATIUM_INSIDE_STRING = 172;
	public static readonly CLOSE_BRACE_INSIDE = 173;
	public static readonly FORMAT_STRING = 174;
	public static readonly DIRECTIVE_WHITESPACES = 175;
	public static readonly DIGITS = 176;
	public static readonly DEFINE = 177;
	public static readonly UNDEF = 178;
	public static readonly ELIF = 179;
	public static readonly ENDIF = 180;
	public static readonly LINE = 181;
	public static readonly ERROR = 182;
	public static readonly WARNING = 183;
	public static readonly REGION = 184;
	public static readonly ENDREGION = 185;
	public static readonly PRAGMA = 186;
	public static readonly DIRECTIVE_HIDDEN = 187;
	public static readonly CONDITIONAL_SYMBOL = 188;
	public static readonly DIRECTIVE_NEW_LINE = 189;
	public static readonly TEXT = 190;
	public static readonly DOUBLE_CURLY_CLOSE_INSIDE = 191;
	...
	public preprocessor_directive(): Preprocessor_directiveContext {
		...
		try {
			...
			case CSharpPreprocessorParser.DEFINE:
				...
				this.directive_new_line_or_sharp();
				 ConditionalSymbols.Add(((_localctx as PreprocessorDeclarationContext)._CONDITIONAL_SYMBOL != null ? (_localctx as PreprocessorDeclarationContext)._CONDITIONAL_SYMBOL.text : undefined));
					   (_localctx as PreprocessorDeclarationContext).value =  conditions.All(c => c); 
				}
				break;
			...
			case CSharpPreprocessorParser.IF:
				...
				this.state = 18;
				this.directive_new_line_or_sharp();
				 (_localctx as PreprocessorConditionalContext).value =  (_localctx as PreprocessorConditionalContext)._expr.value == "true" && conditions.All(c => c); conditions.Push((_localctx as PreprocessorConditionalContext)._expr.value == "true"); 
				}
				break;
			case CSharpPreprocessorParser.ELIF:
				...
				this.state = 23;
				this.directive_new_line_or_sharp();
				 if (!conditions.Peek()) { conditions.Pop(); (_localctx as PreprocessorConditionalContext).value =  (_localctx as PreprocessorConditionalContext)._expr.value == "true" && conditions.All(c => c);
					     conditions.Push((_localctx as PreprocessorConditionalContext)._expr.value == "true"); } else (_localctx as PreprocessorConditionalContext).value =  false; 
				}
				break;
			case CSharpPreprocessorParser.ELSE:
				...
				this.state = 27;
				this.directive_new_line_or_sharp();
				 if (!conditions.Peek()) { conditions.Pop(); (_localctx as PreprocessorConditionalContext).value =  true && conditions.All(c => c); conditions.Push(true); }
			...
			case CSharpPreprocessorParser.LINE:
				...
				this.state = 43;
				this.directive_new_line_or_sharp();
				 (_localctx as PreprocessorLineContext).value =  conditions.All(c => c); 
				}
				break;
			case CSharpPreprocessorParser.ERROR:
				...
				this.state = 48;
				this.directive_new_line_or_sharp();
				 (_localctx as PreprocessorDiagnosticContext).value =  conditions.All(c => c); 
				}
				break;
			...
			case CSharpPreprocessorParser.REGION:
				...
				this.state = 60;
				this.directive_new_line_or_sharp();
				 (_localctx as PreprocessorRegionContext).value =  conditions.All(c => c); 
				}
				break;
			...
			case CSharpPreprocessorParser.PRAGMA:
				...
				this.state = 72;
				this.directive_new_line_or_sharp();
				 (_localctx as PreprocessorPragmaContext).value =  conditions.All(c => c); 
				}
				break;
			default:
				throw new NoViableAltException(this);
