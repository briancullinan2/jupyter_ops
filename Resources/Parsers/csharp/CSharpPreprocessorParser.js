...
;
HashSet < String > ConditionalSymbols;
new HashSet();
{
    {
        ...
        switch (this._input.LA(1)) {
            ...
            case CSharpPreprocessorParser.IF:
                ...
                this.enterOuterAlt(_localctx, 3);
                {
                    ...
                    this.state = 18;
                    this.directive_new_line_or_sharp();
                    _localctx.value = _localctx._expr.value.equals("true") && allConditions();
                    conditions.push(_localctx._expr.value.equals("true"));
                }
                break;
            ...
            case CSharpPreprocessorParser.ELSE:
                ...
                this.enterOuterAlt(_localctx, 5);
                {
                    ...
                    if (!conditions.peek()) {
                        conditions.pop();
                        _localctx.value = true && allConditions();
                        conditions.push(true);
                    }
                    else
                        _localctx.value = false;
