...
export interface CSharpParserVisitor<Result> extends ParseTreeVisitor<Result> {
	...
	/**
	 * Visit a parse tree produced by the `labeledStatement`
	...
	/**
	 * Visit a parse tree produced by the `embeddedStatement`
	 * labeled alternative in `CSharpParser.statement`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitEmbeddedStatement?: (ctx: EmbeddedStatementContext) => Result;
	 ...
	 * @return the visitor result
	 */
	visitLocal_variable_initializer_unsafe?: (ctx: Local_variable_initializer_unsafeContext) => Result;
