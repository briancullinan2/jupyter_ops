...
import { LabeledStatementContext } from "./CSharpParser";
import { DeclarationStatementContext } from "./CSharpParser";
import { EmbeddedStatementContext } from "./CSharpParser";
...
import { Local_variable_initializer_unsafeContext } from "./CSharpParser";
...
export interface CSharpParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the `labeledStatement`
	 * labeled alternative in `CSharpParser.statement`.
	 * @param ctx the parse tree
	 */
	enterLabeledStatement?: (ctx: LabeledStatementContext) => void;
	/**
	 * Exit a parse tree produced by the `labeledStatement`
	 * labeled alternative in `CSharpParser.statement`.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by the `embeddedStatement`
	 * labeled alternative in `CSharpParser.statement`.
	 * @param ctx the parse tree
	 */
	enterEmbeddedStatement?: (ctx: EmbeddedStatementContext) => void;
	/**
	 * Exit a parse tree produced by the `embeddedStatement`
	 * labeled alternative in `CSharpParser.statement`.
	 * @param ctx the parse tree
	 */
	exitEmbeddedStatement?: (ctx: EmbeddedStatementContext) => void;
	 ...
	 * @param ctx the parse tree
	 */
	enterLocal_variable_initializer_unsafe?: (ctx: Local_variable_initializer_unsafeContext) => void;
	/**
	 * Exit a parse tree produced by `CSharpParser.local_variable_initializer_unsafe`.
	 * @param ctx the parse tree
	 */
	exitLocal_variable_initializer_unsafe?: (ctx: Local_variable_initializer_unsafeContext) => void;
