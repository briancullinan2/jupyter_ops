// Generated from C:/Users/megam/jupyter_ops/Resources/Parsers/csharp/v7/CSharpParser.g4 by ANTLR 4.13.2
// jshint ignore: start
...
export default class CSharpParserListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by CSharpParser#stackallocExpression.
	enterStackallocExpression(ctx) {
	}

	// Exit a parse tree produced by CSharpParser#stackallocExpression.
	exitStackallocExpression(ctx) {
	}
	...
	// Enter a parse tree produced by CSharpParser#foreachDeconstructStatement.
	enterForeachDeconstructStatement(ctx) {
	}

	// Exit a parse tree produced by CSharpParser#foreachDeconstructStatement.
	exitForeachDeconstructStatement(ctx) {
	}
	...
	// Enter a parse tree produced by CSharpParser#variable_designation.
	enterVariable_designation(ctx) {
	}

	// Exit a parse tree produced by CSharpParser#variable_designation.
	exitVariable_designation(ctx) {
	}


	// Enter a parse tree produced by CSharpParser#parenthesized_variable_designation.
	enterParenthesized_variable_designation(ctx) {
	}

	// Exit a parse tree produced by CSharpParser#parenthesized_variable_designation.
	exitParenthesized_variable_designation(ctx) {
	}


	// Enter a parse tree produced by CSharpParser#simple_designation.
	enterSimple_designation(ctx) {
	}

	// Exit a parse tree produced by CSharpParser#simple_designation.
	exitSimple_designation(ctx) {
	}
