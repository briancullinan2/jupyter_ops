...
// This class defines a complete listener for a parse tree produced by muddbParser.
export default class muddbListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by muddbParser#next_.
	enterNext_(ctx) {
	}

	// Exit a parse tree produced by muddbParser#next_.
	exitNext_(ctx) {
	}
	...
	// Enter a parse tree produced by muddbParser#bool_.
	enterBool_(ctx) {
	}

	// Exit a parse tree produced by muddbParser#bool_.
	exitBool_(ctx) {
	}
