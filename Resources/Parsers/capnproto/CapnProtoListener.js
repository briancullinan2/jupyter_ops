...
// This class defines a complete listener for a parse tree produced by CapnProtoParser.
export default class CapnProtoListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by CapnProtoParser#type_.
	enterType_(ctx) {
	}

	// Exit a parse tree produced by CapnProtoParser#type_.
	exitType_(ctx) {
	}
