...
export class CapnProtoLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(CapnProtoLexer._LITERAL_NAMES, CapnProtoLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(CapnProtoLexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return CapnProtoLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return CapnProtoLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return CapnProtoLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return CapnProtoLexer.modeNames; }
	...
	public static get _ATN(): ATN {
		if (!CapnProtoLexer.__ATN) {
			CapnProtoLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(CapnProtoLexer._serializedATN));
		}
