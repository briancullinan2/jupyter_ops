...
// This class defines a complete listener for a parse tree produced by RexxParser.
export default class RexxParserListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by RexxParser#file_.
	enterFile_(ctx) {
	}

	// Exit a parse tree produced by RexxParser#file_.
	exitFile_(ctx) {
	}
