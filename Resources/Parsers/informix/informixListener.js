...
// This class defines a complete listener for a parse tree produced by informixParser.
export default class informixListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by informixParser#type_.
	enterType_(ctx) {
	}

	// Exit a parse tree produced by informixParser#type_.
	exitType_(ctx) {
	}


	// Enter a parse tree produced by informixParser#indirectType.
	enterIndirectType(ctx) {
	}

	// Exit a parse tree produced by informixParser#indirectType.
	exitIndirectType(ctx) {
	}
