...
// This class defines a complete listener for a parse tree produced by mooParser.
export default class mooListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by mooParser#property_.
	enterProperty_(ctx) {
	}

	// Exit a parse tree produced by mooParser#property_.
	exitProperty_(ctx) {
	}
	...
	// Enter a parse tree produced by mooParser#list_.
	enterList_(ctx) {
	}

	// Exit a parse tree produced by mooParser#list_.
	exitList_(ctx) {
	}
