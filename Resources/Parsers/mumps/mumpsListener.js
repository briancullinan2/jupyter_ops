...
// This class defines a complete listener for a parse tree produced by mumpsParser.
export default class mumpsListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by mumpsParser#function_.
	enterFunction_(ctx) {
	}

	// Exit a parse tree produced by mumpsParser#function_.
	exitFunction_(ctx) {
	}
