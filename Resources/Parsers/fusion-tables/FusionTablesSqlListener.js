...
// This class defines a complete listener for a parse tree produced by FusionTablesSqlParser.
export default class FusionTablesSqlListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by FusionTablesSqlParser#fusionTablesSql.
	enterFusionTablesSql(ctx) {
	}

	// Exit a parse tree produced by FusionTablesSqlParser#fusionTablesSql.
	exitFusionTablesSql(ctx) {
	}
	...
	// Enter a parse tree produced by FusionTablesSqlParser#operator_.
	enterOperator_(ctx) {
	}

	// Exit a parse tree produced by FusionTablesSqlParser#operator_.
	exitOperator_(ctx) {
	}
