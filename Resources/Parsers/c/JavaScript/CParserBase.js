...
export default class CParserBase extends antlr4.Parser {
    /*
        // Inside CParserBase.js constructor
    constructor(input) {
        super(input);
        ...
        // FORCE BROWSER LOOSE SEMANTIC PARSING:
        // Populating this set forces the grammar predicates to default to 'true',
        // letting the parser skip strict symbol table validations for types/declarations!
