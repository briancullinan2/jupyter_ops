...
10,12,14,16,0,3,2,0,9,9,12,12,3,0,4,7,10,10,12,12,2,0,1,1,4,12,66,0,18,1,
0,0,0,2,30,1,0,0,0,4,36,1,0,0,0,6,38,1,0,0,0,8,42,1,0,0,0,10,44,1,0,0,0,
12,48,1,0,0,0,14,64,1,0,0,0,16,66,1,0,0,0,18,19,3,2,1,0,19,20,5,0,0,1,20,
1,1,0,0,0,21,25,3,4,2,0,22,24,5,3,0,0,23,22,1,0,0,0,24,27,1,0,0,0,25,23,
1,0,0,0,25,26,1,0,0,0,26,29,1,0,0,0,27,25,1,0,0,0,28,21,1,0,0,0,29,32,1,
0,0,0,30,28,1,0,0,0,30,31,1,0,0,0,31,3,1,0,0,0,32,30,1,0,0,0,33,37,3,6,3,
0,34,37,3,10,5,0,35,37,3,14,7,0,36,33,1,0,0,0,36,34,1,0,0,0,36,35,1,0,0,
0,37,5,1,0,0,0,38,39,5,1,0,0,39,40,3,8,4,0,40,41,3,16,8,0,41,7,1,0,0,0,42,
43,7,0,0,0,43,9,1,0,0,0,44,45,5,2,0,0,45,46,3,12,6,0,46,47,3,16,8,0,47,11,
1,0,0,0,48,49,7,1,0,0,49,13,1,0,0,0,50,54,5,8,0,0,51,53,3,16,8,0,52,51,1,
0,0,0,53,56,1,0,0,0,54,52,1,0,0,0,54,55,1,0,0,0,55,65,1,0,0,0,56,54,1,0,
0,0,57,61,5,12,0,0,58,60,3,16,8,0,59,58,1,0,0,0,60,63,1,0,0,0,61,59,1,0,
0,0,61,62,1,0,0,0,62,65,1,0,0,0,63,61,1,0,0,0,64,50,1,0,0,0,64,57,1,0,0,
0,65,15,1,0,0,0,66,67,7,2,0,0,67,17,1,0,0,0,6,25,30,36,54,61,64];
...
export default class Q3ConfigParser extends antlr4.Parser {
    ...
    static symbolicNames = [ null, "ASSIGNMENT_KEYWORD", "BIND_KEYWORD", 
                             "SEMICOLON", "EQUALS", "BACKSLASH", "BACKTICK", 
                             "TILDE", "COMMAND_KEYWORD", "KNOWN_CVAR", "NUMBER", 
                             "STRING_LITERAL", "IDENTIFIER", "COMMENT", 
...
Q3ConfigParser.SEMICOLON = 3;
Q3ConfigParser.EQUALS = 4;
Q3ConfigParser.BACKSLASH = 5;
Q3ConfigParser.BACKTICK = 6;
Q3ConfigParser.TILDE = 7;
Q3ConfigParser.COMMAND_KEYWORD = 8;
Q3ConfigParser.KNOWN_CVAR = 9;
Q3ConfigParser.NUMBER = 10;
Q3ConfigParser.STRING_LITERAL = 11;
Q3ConfigParser.IDENTIFIER = 12;
Q3ConfigParser.COMMENT = 13;
Q3ConfigParser.LINE_COMMENT_SL = 14;
Q3ConfigParser.LINE_COMMENT_BS = 15;
Q3ConfigParser.WS = 16;
...
class BindKeyContext extends antlr4.ParserRuleContext {
	...
	EQUALS() {
	    return this.getToken(Q3ConfigParser.EQUALS, 0);
	};

	BACKSLASH() {
	    return this.getToken(Q3ConfigParser.BACKSLASH, 0);
	};

	BACKTICK() {
	    return this.getToken(Q3ConfigParser.BACKTICK, 0);
	};

	TILDE() {
	    return this.getToken(Q3ConfigParser.TILDE, 0);
	};
