...
// This class defines a complete listener for a parse tree produced by moleculeParser.
export default class moleculeListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by moleculeParser#part_.
	enterPart_(ctx) {
	}

	// Exit a parse tree produced by moleculeParser#part_.
	exitPart_(ctx) {
	}
