...
export interface Protobuf3Visitor<Result> extends ParseTreeVisitor<Result> {
	 ...
	 * @return the visitor result
	 */
	visitOptionBody?: (ctx: OptionBodyContext) => Result;
	 ...
	 * @return the visitor result
	 */
	visitOptionBodyVariable?: (ctx: OptionBodyVariableContext) => Result;
	...
	/**
	 * Visit a parse tree produced by `Protobuf3Parser.range`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	 ...
	 * @return the visitor result
	 */
	visitFieldNames?: (ctx: FieldNamesContext) => Result;

	/**
	 * Visit a parse tree produced by `Protobuf3Parser.type`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	 ...
	 * @return the visitor result
	 */
	visitMessageOrEnumName?: (ctx: MessageOrEnumNameContext) => Result;
	 ...
	 * @return the visitor result
	 */
	visitMessageOrEnumType?: (ctx: MessageOrEnumTypeContext) => Result;
