...
export default class PROV_NListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by PROV_NParser#namespace_.
	enterNamespace_(ctx) {
	}

	// Exit a parse tree produced by PROV_NParser#namespace_.
	exitNamespace_(ctx) {
	}
