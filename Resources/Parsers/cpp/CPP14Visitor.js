// Generated from ./Resources/Parsers/cpp/CPP14.g4 by ANTLR 4.8
// jshint ignore: start
...
CPP14Visitor.prototype.visitTypeidofexpr = function(ctx) {
  return this.visitChildren(ctx);
};


// Visit a parse tree produced by CPP14Parser#typeidofthetypeid.
CPP14Visitor.prototype.visitTypeidofthetypeid = function(ctx) {
  return this.visitChildren(ctx);
};
...
CPP14Visitor.prototype.visitShiftoperator = function(ctx) {
  return this.visitChildren(ctx);
};
...
CPP14Visitor.prototype.visitThetypename = function(ctx) {
  return this.visitChildren(ctx);
};
...
CPP14Visitor.prototype.visitThetypeid = function(ctx) {
  return this.visitChildren(ctx);
};
...
CPP14Visitor.prototype.visitTheoperator = function(ctx) {
  return this.visitChildren(ctx);
};
