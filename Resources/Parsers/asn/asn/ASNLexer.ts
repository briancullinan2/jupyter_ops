...
export class ASNLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(ASNLexer._LITERAL_NAMES, ASNLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(ASNLexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return ASNLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return ASNLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return ASNLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return ASNLexer.modeNames; }

	private static readonly _serializedATNSegments: number = 2;
	private static readonly _serializedATNSegment0: string =
		"\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02j\u039B\b\x01" +
	...
	private static readonly _serializedATNSegment1: string =
		"G\x02\x02\u01C9\u01CA\x07T\x02\x02\u01CA\u01CB\x07U\x02\x02\u01CB\u01CC" +
	...
	public static get _ATN(): ATN {
		if (!ASNLexer.__ATN) {
			ASNLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(ASNLexer._serializedATN));
		}
