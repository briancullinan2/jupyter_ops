...
export class datetimeLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(datetimeLexer._LITERAL_NAMES, datetimeLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(datetimeLexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return datetimeLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return datetimeLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return datetimeLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return datetimeLexer.modeNames; }
	...
	public static get _ATN(): ATN {
		if (!datetimeLexer.__ATN) {
			datetimeLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(datetimeLexer._serializedATN));
		}
