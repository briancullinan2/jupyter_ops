...
// This class defines a complete listener for a parse tree produced by SwiftFinParser.
export default class SwiftFinParserListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by SwiftFinParser#map_.
	enterMap_(ctx) {
	}

	// Exit a parse tree produced by SwiftFinParser#map_.
	exitMap_(ctx) {
	}
