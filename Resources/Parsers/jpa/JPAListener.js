...
// This class defines a complete listener for a parse tree produced by JPAParser.
export default class JPAListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by JPAParser#file_.
	enterFile_(ctx) {
	}

	// Exit a parse tree produced by JPAParser#file_.
	exitFile_(ctx) {
	}


	// Enter a parse tree produced by JPAParser#ql_statement.
	enterQl_statement(ctx) {
	}

	// Exit a parse tree produced by JPAParser#ql_statement.
	exitQl_statement(ctx) {
	}
