...
// This class defines a complete listener for a parse tree produced by CLIFParser.
export default class CLIFListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by CLIFParser#operator_.
	enterOperator_(ctx) {
	}

	// Exit a parse tree produced by CLIFParser#operator_.
	exitOperator_(ctx) {
	}
