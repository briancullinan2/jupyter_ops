...
export class CLIFLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(CLIFLexer._LITERAL_NAMES, CLIFLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(CLIFLexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return CLIFLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return CLIFLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return CLIFLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return CLIFLexer.modeNames; }

	public static readonly _serializedATN: string =
		"\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\x1E\u0132\b\x01" +
	...
	public static get _ATN(): ATN {
		if (!CLIFLexer.__ATN) {
			CLIFLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(CLIFLexer._serializedATN));
		}
