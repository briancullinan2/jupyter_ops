...
import { PreambleContext } from "./KotlinParser";
import { FileAnnotationsContext } from "./KotlinParser";
...
import { BlockLevelExpressionContext } from "./KotlinParser";
...
import { EqualityComparisonContext } from "./KotlinParser";
import { ComparisonContext } from "./KotlinParser";
import { NamedInfixContext } from "./KotlinParser";
...
import { EqualityOperationContext } from "./KotlinParser";
...
import { MultiplicativeOperationContext } from "./KotlinParser";
import { TypeOperationContext } from "./KotlinParser";
import { PrefixUnaryOperationContext } from "./KotlinParser";
import { PostfixUnaryOperationContext } from "./KotlinParser";
...
import { AnysemiContext } from "./KotlinParser";
...
export interface KotlinParserVisitor<Result> extends ParseTreeVisitor<Result> {
	 ...
	 * @return the visitor result
	 */
	visitFileAnnotations?: (ctx: FileAnnotationsContext) => Result;
	 ...
	 * @return the visitor result
	 */
	visitBlockLevelExpression?: (ctx: BlockLevelExpressionContext) => Result;
	 ...
	 * @return the visitor result
	 */
	visitNamedInfix?: (ctx: NamedInfixContext) => Result;
	 ...
	 * @return the visitor result
	 */
	visitTypeRHS?: (ctx: TypeRHSContext) => Result;
	 ...
	 * @return the visitor result
	 */
	visitEqualityOperation?: (ctx: EqualityOperationContext) => Result;
	 ...
	 * @return the visitor result
	 */
	visitTypeOperation?: (ctx: TypeOperationContext) => Result;
	 ...
	 * @return the visitor result
	 */
	visitPrefixUnaryOperation?: (ctx: PrefixUnaryOperationContext) => Result;
	 ...
	 * @return the visitor result
	 */
	visitPostfixUnaryOperation?: (ctx: PostfixUnaryOperationContext) => Result;
	 ...
	 * @return the visitor result
	 */
	visitAnysemi?: (ctx: AnysemiContext) => Result;
}
