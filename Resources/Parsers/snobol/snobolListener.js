...
// This class defines a complete listener for a parse tree produced by snobolParser.
export default class snobolListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by snobolParser#array_.
	enterArray_(ctx) {
	}

	// Exit a parse tree produced by snobolParser#array_.
	exitArray_(ctx) {
	}
