// Generated from Resources/Parsers/less/LessParser.g4 by ANTLR 4.10.1
// jshint ignore: start
import antlr4 from 'antlr4';

// This class defines a complete listener for a parse tree produced by LessParser.
export default class LessParserListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by LessParser#function_.
	enterFunction_(ctx) {
	}

	// Exit a parse tree produced by LessParser#function_.
	exitFunction_(ctx) {
	}
	...
	// Enter a parse tree produced by LessParser#property_.
	enterProperty_(ctx) {
	}

	// Exit a parse tree produced by LessParser#property_.
	exitProperty_(ctx) {
	}
