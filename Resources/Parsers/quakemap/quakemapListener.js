...
// This class defines a complete listener for a parse tree produced by quakemapParser.
export default class quakemapListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by quakemapParser#map_.
	enterMap_(ctx) {
	}

	// Exit a parse tree produced by quakemapParser#map_.
	exitMap_(ctx) {
	}
