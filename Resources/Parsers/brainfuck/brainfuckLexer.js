// Generated from Resources/Parsers/brainfuck/brainfuck.g4 by ANTLR 4.10.1
// jshint ignore: start
...
13,31,1,0,0,0,15,33,1,0,0,0,17,35,1,0,0,0,19,20,5,62,0,0,20,2,1,0,0,0,21,
22,5,60,0,0,22,4,1,0,0,0,23,24,5,43,0,0,24,6,1,0,0,0,25,26,5,45,0,0,26,8,
1,0,0,0,27,28,5,46,0,0,28,10,1,0,0,0,29,30,5,44,0,0,30,12,1,0,0,0,31,32,
...
export default class brainfuckLexer extends antlr4.Lexer {
	...
	static symbolicNames = [ null, "GT", "LT", "PLUS", "MINUS", "DOT", "COMMA", 
                          "LPAREN", "RPAREN", "WS" ];
	static ruleNames = [ "GT", "LT", "PLUS", "MINUS", "DOT", "COMMA", "LPAREN", 
                      "RPAREN", "WS" ];
...
brainfuckLexer.EOF = antlr4.Token.EOF;
brainfuckLexer.GT = 1;
brainfuckLexer.LT = 2;
