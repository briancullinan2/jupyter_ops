...
var CSVLexer = /** @class */ (function (_super) {
    ...
    function CSVLexer(input) {
        ...
        _this._interp = new LexerATNSimulator_1.LexerATNSimulator(CSVLexer._ATN, _this);
        return _this;
    }
    ...
    Object.defineProperty(CSVLexer, "_ATN", {
        get: function () {
            if (!CSVLexer.__ATN) {
                CSVLexer.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(CSVLexer._serializedATN));
            }
    ...
    CSVLexer.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(CSVLexer._LITERAL_NAMES, CSVLexer._SYMBOLIC_NAMES, []);
