...
export class CSVParser extends Parser {
	...
	public static readonly RULE_csvFile = 0;
	...
	// @RuleVersion(0)
	public csvFile(): CsvFileContext {
		let _localctx: CsvFileContext = new CsvFileContext(this._ctx, this.state);
...
export class CsvFileContext extends ParserRuleContext {
	public hdr(): HdrContext {
	...
	// @Override
	public get ruleIndex(): number { return CSVParser.RULE_csvFile; }
	// @Override
...
export class FieldContext extends ParserRuleContext {
	public TEXT(): TerminalNode | undefined { return this.tryGetToken(CSVParser.TEXT, 0); }
