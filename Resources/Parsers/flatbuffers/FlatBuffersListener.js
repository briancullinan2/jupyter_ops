...
// This class defines a complete listener for a parse tree produced by FlatBuffersParser.
export default class FlatBuffersListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by FlatBuffersParser#union_decl.
	enterUnion_decl(ctx) {
	}

	// Exit a parse tree produced by FlatBuffersParser#union_decl.
	exitUnion_decl(ctx) {
	}
	...
	// Enter a parse tree produced by FlatBuffersParser#type_.
	enterType_(ctx) {
	}

	// Exit a parse tree produced by FlatBuffersParser#type_.
	exitType_(ctx) {
	}


	// Enter a parse tree produced by FlatBuffersParser#enumval_decl.
	enterEnumval_decl(ctx) {
	}

	// Exit a parse tree produced by FlatBuffersParser#enumval_decl.
	exitEnumval_decl(ctx) {
	}


	// Enter a parse tree produced by FlatBuffersParser#commasep_enumval_decl.
	enterCommasep_enumval_decl(ctx) {
	}

	// Exit a parse tree produced by FlatBuffersParser#commasep_enumval_decl.
	exitCommasep_enumval_decl(ctx) {
	}


	// Enter a parse tree produced by FlatBuffersParser#unionval_with_opt_alias.
	enterUnionval_with_opt_alias(ctx) {
	}

	// Exit a parse tree produced by FlatBuffersParser#unionval_with_opt_alias.
	exitUnionval_with_opt_alias(ctx) {
	}


	// Enter a parse tree produced by FlatBuffersParser#commasep_unionval_with_opt_alias.
	enterCommasep_unionval_with_opt_alias(ctx) {
	}

	// Exit a parse tree produced by FlatBuffersParser#commasep_unionval_with_opt_alias.
	exitCommasep_unionval_with_opt_alias(ctx) {
	}
	...
	enterCommasep_ident_with_opt_single_value(ctx) {
	}

	// Exit a parse tree produced by FlatBuffersParser#commasep_ident_with_opt_single_value.
	exitCommasep_ident_with_opt_single_value(ctx) {
	}
	...
	// Enter a parse tree produced by FlatBuffersParser#keywords.
	enterKeywords(ctx) {
	}

	// Exit a parse tree produced by FlatBuffersParser#keywords.
	exitKeywords(ctx) {
	}
