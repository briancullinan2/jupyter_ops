...
export default class modelicaListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by modelicaParser#stored_definition.
	enterStored_definition(ctx) {
	}

	// Exit a parse tree produced by modelicaParser#stored_definition.
	exitStored_definition(ctx) {
	}
