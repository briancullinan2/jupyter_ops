...
// This class defines a complete listener for a parse tree produced by algol60Parser.
export default class algol60Listener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by algol60Parser#empty_.
	enterEmpty_(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#empty_.
	exitEmpty_(ctx) {
	}
	...
	// Enter a parse tree produced by algol60Parser#number.
	enterNumber(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#number.
	exitNumber(ctx) {
	}
	...
	enterSimple_arithmetic_expression(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#simple_arithmetic_expression.
	exitSimple_arithmetic_expression(ctx) {
	}
	...
	// Enter a parse tree produced by algol60Parser#boolean_primary.
	enterBoolean_primary(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#boolean_primary.
	exitBoolean_primary(ctx) {
	}


	// Enter a parse tree produced by algol60Parser#boolean_secondary.
	enterBoolean_secondary(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#boolean_secondary.
	exitBoolean_secondary(ctx) {
	}


	// Enter a parse tree produced by algol60Parser#boolean_factor.
	enterBoolean_factor(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#boolean_factor.
	exitBoolean_factor(ctx) {
	}


	// Enter a parse tree produced by algol60Parser#boolean_term.
	enterBoolean_term(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#boolean_term.
	exitBoolean_term(ctx) {
	}


	// Enter a parse tree produced by algol60Parser#implication.
	enterImplication(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#implication.
	exitImplication(ctx) {
	}


	// Enter a parse tree produced by algol60Parser#simple_boolean.
	enterSimple_boolean(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#simple_boolean.
	exitSimple_boolean(ctx) {
	}
	...
	// Enter a parse tree produced by algol60Parser#unlabelled_compound.
	enterUnlabelled_compound(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#unlabelled_compound.
	exitUnlabelled_compound(ctx) {
	}


	// Enter a parse tree produced by algol60Parser#unlabelled_block.
	enterUnlabelled_block(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#unlabelled_block.
	exitUnlabelled_block(ctx) {
	}
	...
	// Enter a parse tree produced by algol60Parser#destination.
	enterDestination(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#destination.
	exitDestination(ctx) {
	}
	...
	enterGo_to_statement(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#go_to_statement.
	exitGo_to_statement(ctx) {
	}


	// Enter a parse tree produced by algol60Parser#dummy_statement.
	enterDummy_statement(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#dummy_statement.
	exitDummy_statement(ctx) {
	}
	...
	enterProcedure_statement(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#procedure_statement.
	exitProcedure_statement(ctx) {
	}


	// Enter a parse tree produced by algol60Parser#code.
	enterCode(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#code.
	exitCode(ctx) {
	}
	...
	// Enter a parse tree produced by algol60Parser#type_.
	enterType_(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#type_.
	exitType_(ctx) {
	}


	// Enter a parse tree produced by algol60Parser#local_or_own.
	enterLocal_or_own(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#local_or_own.
	exitLocal_or_own(ctx) {
	}
	...
	// Enter a parse tree produced by algol60Parser#array_declarer.
	enterArray_declarer(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#array_declarer.
	exitArray_declarer(ctx) {
	}


	// Enter a parse tree produced by algol60Parser#array_declaration.
	enterArray_declaration(ctx) {
	}

	// Exit a parse tree produced by algol60Parser#array_declaration.
	exitArray_declaration(ctx) {
	}


	// Enter a parse tree produced by algol60Parser#switch_list.
	enterSwitch_list(ctx) {
	}
