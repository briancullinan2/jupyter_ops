...
export class sgfLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(sgfLexer._LITERAL_NAMES, sgfLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(sgfLexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return sgfLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return sgfLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return sgfLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return sgfLexer.modeNames; }

	public static readonly _serializedATN: string =
		"\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02P\u0191\b\x01" +
	...
	public static get _ATN(): ATN {
		if (!sgfLexer.__ATN) {
			sgfLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(sgfLexer._serializedATN));
		}
