...
// This class defines a complete listener for a parse tree produced by sgfParser.
export default class sgfListener extends antlr4.tree.ParseTreeListener {
	...
	// Enter a parse tree produced by sgfParser#property_.
	enterProperty_(ctx) {
	}

	// Exit a parse tree produced by sgfParser#property_.
	exitProperty_(ctx) {
	}
	...
	// Enter a parse tree produced by sgfParser#go_.
	enterGo_(ctx) {
	}

	// Exit a parse tree produced by sgfParser#go_.
	exitGo_(ctx) {
	}


	// Enter a parse tree produced by sgfParser#privateProp.
	enterPrivateProp(ctx) {
	}
