router.post('/session', session.createSession); // ExecuteCreateSession
router.get('/sessions', () => {
...
router.delete('/session/:sessionId', session.quit); // ExecuteQuit
...
router.post('/session/:sessionId/element', () => {
    throw new Error('not implemented!');
}); //,"FindElement",ExecuteFindElement, 50,
router.post('/session/:sessionId/elements', () => {
    throw new Error('not implemented!');
}); //,"FindElements",ExecuteFindElements, 50,
...
router.get('/session/:sessionId/application_cache/status', ExecuteGetStatus);
